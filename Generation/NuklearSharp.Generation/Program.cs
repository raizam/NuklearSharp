	...
	class Program
	{
		...
		private static void Convert()
		{
			...
			parameters.StructSource = n =>
			{
				...
				return parameters.TreatStructAsClass(n)
					? @"..\..\..\..\..\NuklearSharp\Nuklear.Classes.Generated.cs"
					: @"..\..\..\..\..\NuklearSharp\Nuklear.Structs.Generated.cs";
			};
			...
			{
				if (skipFunctions.Contains(n))
				{
					return null;
				}

				if (n.StartsWith("nk_rp_") || n.StartsWith("nk_rect_"))
				{
					return @"..\..\..\..\..\NuklearSharp\Nuklear.RectPacts.Generated.cs";
				}

				if (n.StartsWith("nk_tt_") || n.StartsWith("nk_font_bake"))
				{
					return @"..\..\..\..\..\NuklearSharp\Nuklear.TrueType.Generated.cs";
				}

				if (n.StartsWith("nk_input_"))
				{
					return @"..\..\..\..\..\NuklearSharp\Nuklear.Input.Generated.cs";
				}

				if (n.StartsWith("nk_text_edit_") || n.StartsWith("nk_textedit"))
				{
					return @"..\..\..\..\..\NuklearSharp\Nuklear.TextEdit.Generated.cs";
				}

				if (n.StartsWith("nk_widget_") ||
					n.StartsWith("nk_do_") || 
					n.Contains("behavior") ||
					n.Contains("button") ||
					n.Contains("checkbox") ||
					n.Contains("option") ||
					n.Contains("toggle") ||
					n.Contains("selectable") ||
					n.Contains("slider") ||
					n.Contains("progress") ||
					n.Contains("scrollbar") ||
					n.Contains("filter") ||
					n.Contains("_edit") ||
					n.Contains("property") ||
					n.Contains("picker") ||
					...
					n.Contains("plot") ||
					n.Contains("group") ||
					n.Contains("list_view") ||
					n.Contains("contextual") ||
					n.Contains("combo") ||
					n.Contains("menu") ||
					n.Contains("tooltip") ||
					n.Contains("color_pick") ||
					n.Contains("nonblock") ||
					n.Contains("nk_begin") ||
					n.Contains("nk_end") ||
					n.Contains("tree") ||
					...
					n.Contains("layout"))
				{
					return @"..\..\..\..\..\NuklearSharp\Nuklear.UI.Generated.cs";
				}


				return @"..\..\..\..\..\NuklearSharp\Nuklear.Utility.Generated.cs";
			};

			parameters.TreatGlobalPointerAsArray = n => globalArrays.Contains(n);
			parameters.TreatStructAsClass =
				n =>
					treatAsClasses.Contains(n) || n.StartsWith("nk_command_") || n.StartsWith("nk_style_") ||
			...
			{
				if (output.Key.Contains("Classes") || 
					output.Key.Contains("Structs") ||
					output.Key.Contains("GlobalVariables") ||
					output.Key.Contains("Enums") ||
					output.Key.Contains("RectPacts") ||
					output.Key.Contains("Input") ||
					output.Key.Contains("TextEdit") ||
					output.Key.Contains("TrueType")
					)
				{
					continue;
				}
		...
		private static string PostProcess(string data)
		{
			...
			data =
				data.Replace(
					"if ((ctx.use_pool) != 0) nk_buffer_clear(ctx.memory); else nk_buffer_reset(ctx.memory, (int)(NK_BUFFER_FRONT));",
