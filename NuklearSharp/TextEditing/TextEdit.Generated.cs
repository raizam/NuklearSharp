...
namespace NuklearSharp
{
	public unsafe partial class TextEdit
	{
		...
		public Nuklear.NkPluginFilter filter;
		...
		public float GetWidth(int line_start, int char_id, UserFont font)
		{
			int len = (int)(0);
			char unicode = (char)0;
		...
		public int LocateCoord(float x, float y, UserFont font, float row_height)
		{
			...
			r.num_chars = (int)(0);
			while ((i) < (n)) {
r.outRow(this, (int)(i), (float)(row_height), font);if (r.num_chars <= 0) return (int)(n);if (((i) == (0)) && ((y) < (base_y + r.ymin))) return (int)(0);if ((y) < (base_y + r.ymax)) break;i += (int)(r.num_chars);base_y += (float)(r.baseline_y_delta);}
			if ((i) >= (n)) return (int)(n);
			if ((x) < (r.x0)) return (int)(i);
			if ((x) < (r.x1)) {
k = (int)(i);prev_x = (float)(r.x0);for (i = (int)(0); (i) < (r.num_chars); ++i) {
float w = (float)(GetWidth((int)(k), (int)(i), font));if ((x) < (prev_x + w)) {
...
prev_x += (float)(w);}}
		...
		public void Click(float x, float y, UserFont font, float row_height)
		{
			this.cursor = (int)(LocateCoord((float)(x), (float)(y), font, (float)(row_height)));
			this.select_start = (int)(this.cursor);
			this.select_end = (int)(this.cursor);
			this.has_preferred_x = (byte)(0);
		}

		public void Drag(float x, float y, UserFont font, float row_height)
		{
			int p = (int)(LocateCoord((float)(x), (float)(y), font, (float)(row_height)));
...
if ((this.select_start) > (n)) this.select_start = (int)(n);if ((this.select_end) > (n)) this.select_end = (int)(n);if ((this.select_start) == (this.select_end)) this.cursor = (int)(this.select_start);}
		...
		public void DeleteSelection()
		{
			...
			if (((this).select_start != (this).select_end)) {
if ((this.select_start) < (this.select_end)) {
Delete((int)(this.select_start), (int)(this.select_end - this.select_start));this.select_end = (int)(this.cursor = (int)(this.select_start));}
 else {
Delete((int)(this.select_end), (int)(this.select_start - this.select_end));this.select_start = (int)(this.cursor = (int)(this.select_end));}
this.has_preferred_x = (byte)(0);}
...
int temp = (int)(this.select_end);this.select_end = (int)(this.select_start);this.select_start = (int)(temp);}
		...
		{
			if (((this).select_start != (this).select_end)) {
Sortselection();this.cursor = (int)(this.select_start);this.select_end = (int)(this.select_start);this.has_preferred_x = (byte)(0);}
		...
		{
			if (((this).select_start != (this).select_end)) {
Sortselection();Clamp();this.cursor = (int)(this.select_end);this.select_start = (int)(this.select_end);this.has_preferred_x = (byte)(0);}
		...
		public int Cut()
		{
			...
			if (((this).select_start != (this).select_end)) {
DeleteSelection();this.has_preferred_x = (byte)(0);return (int)(1);}

			return (int)(0);
		}

		public int Paste(char* ctext, int len)
		{
			int glyphs;
			char* text = ctext;
			if ((this.mode) == (Nuklear.NK_TEXT_EDIT_MODE_VIEW)) return (int)(0);
...
MakeundoInsert((int)(this.cursor), (int)(glyphs));this.cursor += (int)(len);this.has_preferred_x = (byte)(0);return (int)(1);}

			if ((this.undo.undo_point) != 0) --this.undo.undo_point;
			return (int)(0);
		}

		public void Text(char* text, int total_len)
		{
			char unicode;
			int glyph_len;
			int text_len = (int)(0);
...
MakeundoReplace((int)(this.cursor), (int)(1), (int)(1));this._string_.DeleteRunes((int)(this.cursor), (int)(1));}
if ((this._string_.InsertTextUtf8((int)(this.cursor), text + text_len, (int)(1))) != 0) {
++this.cursor;this.has_preferred_x = (byte)(0);}
}
 else {
DeleteSelection();if ((this._string_.InsertTextUtf8((int)(this.cursor), text + text_len, (int)(1))) != 0) {
MakeundoInsert((int)(this.cursor), (int)(1));++this.cursor;this.has_preferred_x = (byte)(0);}
}
next:;
text_len += (int)(glyph_len);glyph_len = (int)(Nuklear.UtfDecode(text + text_len, &unicode, (int)(total_len - text_len)));}
		}

		public void Key(int key, int shift_mod, UserFont font, float row_height)
		{
			retry:;
switch (key){
case Nuklear.NK_KEY_NONE:case Nuklear.NK_KEY_CTRL:case Nuklear.NK_KEY_ENTER:case Nuklear.NK_KEY_SHIFT:case Nuklear.NK_KEY_TAB:case Nuklear.NK_KEY_COPY:case Nuklear.NK_KEY_CUT:case Nuklear.NK_KEY_PASTE:case Nuklear.NK_KEY_MAX:default: break;case Nuklear.NK_KEY_TEXT_UNDO:Undo();this.has_preferred_x = (byte)(0);break;case Nuklear.NK_KEY_TEXT_REDO:Redo();this.has_preferred_x = (byte)(0);break;case Nuklear.NK_KEY_TEXT_SELECT_ALL:SelectAll();this.has_preferred_x = (byte)(0);break;case Nuklear.NK_KEY_TEXT_INSERT_MODE:if ((this.mode) == (Nuklear.NK_TEXT_EDIT_MODE_VIEW)) this.mode = (byte)(Nuklear.NK_TEXT_EDIT_MODE_INSERT);break;case Nuklear.NK_KEY_TEXT_REPLACE_MODE:if ((this.mode) == (Nuklear.NK_TEXT_EDIT_MODE_VIEW)) this.mode = (byte)(Nuklear.NK_TEXT_EDIT_MODE_REPLACE);break;case Nuklear.NK_KEY_TEXT_RESET_MODE:if (((this.mode) == (Nuklear.NK_TEXT_EDIT_MODE_INSERT)) || ((this.mode) == (Nuklear.NK_TEXT_EDIT_MODE_REPLACE))) this.mode = (byte)(Nuklear.NK_TEXT_EDIT_MODE_VIEW);break;case Nuklear.NK_KEY_LEFT:if ((shift_mod) != 0) {
Clamp();PrepSelectionAtCursor();if ((this.select_end) > (0)) --this.select_end;this.cursor = (int)(this.select_end);this.has_preferred_x = (byte)(0);}
 else {
if (((this).select_start != (this).select_end)) MoveToFirst(); else if ((this.cursor) > (0)) --this.cursor;this.has_preferred_x = (byte)(0);}
break;case Nuklear.NK_KEY_RIGHT:if ((shift_mod) != 0) {
PrepSelectionAtCursor();++this.select_end;Clamp();this.cursor = (int)(this.select_end);this.has_preferred_x = (byte)(0);}
 else {
if (((this).select_start != (this).select_end)) MoveToLast(); else ++this.cursor;Clamp();this.has_preferred_x = (byte)(0);}
break;case Nuklear.NK_KEY_TEXT_WORD_LEFT:if ((shift_mod) != 0) {
if (!((this).select_start != (this).select_end)) PrepSelectionAtCursor();this.cursor = (int)(MoveToWordPrevious());this.select_end = (int)(this.cursor);Clamp();}
 else {
if (((this).select_start != (this).select_end)) MoveToFirst(); else {
this.cursor = (int)(MoveToWordPrevious());Clamp();}
}
break;case Nuklear.NK_KEY_TEXT_WORD_RIGHT:if ((shift_mod) != 0) {
if (!((this).select_start != (this).select_end)) PrepSelectionAtCursor();this.cursor = (int)(MoveToWordNext());this.select_end = (int)(this.cursor);Clamp();}
 else {
if (((this).select_start != (this).select_end)) MoveToLast(); else {
this.cursor = (int)(MoveToWordNext());Clamp();}
}
...
if ((sel) != 0) PrepSelectionAtCursor(); else if (((this).select_start != (this).select_end)) MoveToLast();Clamp();find.FindCharpos(this, (int)(this.cursor), (int)(this.single_line), font, (float)(row_height));if ((find.length) != 0) {
float x;float goal_x = (float)((this.has_preferred_x) != 0?this.preferred_x:find.x);int start = (int)(find.first_char + find.length);this.cursor = (int)(start);row.outRow(this, (int)(this.cursor), (float)(row_height), font);x = (float)(row.x0);for (i = (int)(0); ((i) < (row.num_chars)) && ((x) < (row.x1)); ++i) {
float dx = (float)(GetWidth((int)(start), (int)(i), font));x += (float)(dx);if ((x) > (goal_x)) break;++this.cursor;}Clamp();this.has_preferred_x = (byte)(1);this.preferred_x = (float)(goal_x);if ((sel) != 0) this.select_end = (int)(this.cursor);}
}
break;case Nuklear.NK_KEY_UP:{
TextFind find =  new TextFind();TextEditRow row =  new TextEditRow();int i;int sel = (int)(shift_mod);if ((this.single_line) != 0) {
key = (int)(Nuklear.NK_KEY_LEFT);goto retry;}
if ((sel) != 0) PrepSelectionAtCursor(); else if (((this).select_start != (this).select_end)) MoveToFirst();Clamp();find.FindCharpos(this, (int)(this.cursor), (int)(this.single_line), font, (float)(row_height));if (find.prev_first != find.first_char) {
float x;float goal_x = (float)((this.has_preferred_x) != 0?this.preferred_x:find.x);this.cursor = (int)(find.prev_first);row.outRow(this, (int)(this.cursor), (float)(row_height), font);x = (float)(row.x0);for (i = (int)(0); ((i) < (row.num_chars)) && ((x) < (row.x1)); ++i) {
float dx = (float)(GetWidth((int)(find.prev_first), (int)(i), font));x += (float)(dx);if ((x) > (goal_x)) break;++this.cursor;}Clamp();this.has_preferred_x = (byte)(1);this.preferred_x = (float)(goal_x);if ((sel) != 0) this.select_end = (int)(this.cursor);}
}
break;case Nuklear.NK_KEY_DEL:if ((this.mode) == (Nuklear.NK_TEXT_EDIT_MODE_VIEW)) break;if (((this).select_start != (this).select_end)) DeleteSelection(); else {
int n = (int)(this._string_.len);if ((this.cursor) < (n)) Delete((int)(this.cursor), (int)(1));}
this.has_preferred_x = (byte)(0);break;case Nuklear.NK_KEY_BACKSPACE:if ((this.mode) == (Nuklear.NK_TEXT_EDIT_MODE_VIEW)) break;if (((this).select_start != (this).select_end)) DeleteSelection(); else {
Clamp();if ((this.cursor) > (0)) {
Delete((int)(this.cursor - 1), (int)(1));--this.cursor;}
}
this.has_preferred_x = (byte)(0);break;case Nuklear.NK_KEY_TEXT_START:if ((shift_mod) != 0) {
PrepSelectionAtCursor();this.cursor = (int)(this.select_end = (int)(0));this.has_preferred_x = (byte)(0);}
 else {
...
PrepSelectionAtCursor();this.cursor = (int)(this.select_end = (int)(this._string_.len));this.has_preferred_x = (byte)(0);}
 else {
...
if ((shift_mod) != 0) {
TextFind find =  new TextFind();Clamp();PrepSelectionAtCursor();if (((this._string_.len) != 0) && ((this.cursor) == (this._string_.len))) --this.cursor;find.FindCharpos(this, (int)(this.cursor), (int)(this.single_line), font, (float)(row_height));this.cursor = (int)(this.select_end = (int)(find.first_char));this.has_preferred_x = (byte)(0);}
 else {
TextFind find =  new TextFind();if (((this._string_.len) != 0) && ((this.cursor) == (this._string_.len))) --this.cursor;Clamp();MoveToFirst();find.FindCharpos(this, (int)(this.cursor), (int)(this.single_line), font, (float)(row_height));this.cursor = (int)(find.first_char);this.has_preferred_x = (byte)(0);}
}
break;case Nuklear.NK_KEY_TEXT_LINE_END:{
if ((shift_mod) != 0) {
TextFind find =  new TextFind();Clamp();PrepSelectionAtCursor();find.FindCharpos(this, (int)(this.cursor), (int)(this.single_line), font, (float)(row_height));this.has_preferred_x = (byte)(0);this.cursor = (int)(find.first_char + find.length);if (((find.length) > (0)) && ((this._string_.RuneAt((int)(this.cursor - 1))) == ('\n'))) --this.cursor;this.select_end = (int)(this.cursor);}
 else {
TextFind find =  new TextFind();Clamp();MoveToFirst();find.FindCharpos(this, (int)(this.cursor), (int)(this.single_line), font, (float)(row_height));this.has_preferred_x = (byte)(0);this.cursor = (int)(find.first_char + find.length);if (((find.length) > (0)) && ((this._string_.RuneAt((int)(this.cursor - 1))) == ('\n'))) --this.cursor;}
}
break;}
...
s.rdRedo();if ((s.redo_point) == (99)) return;}r = (TextUndoRecord *)s.undo_rec + s.redo_point - 1;r->char_storage = ((short)(s.redo_char_point - u.delete_length));s.redo_char_point = ((short)(s.redo_char_point - u.delete_length));for (i = (int)(0); (i) < (u.delete_length); ++i) {s.undo_char[r->char_storage + i] = (char)(this._string_.RuneAt((int)(u.where + i)));}}
...
s.undo_char[u->char_storage + i] = (char)(this._string_.RuneAt((int)(u->where + i)));}}
...
this._string_.InsertTextRunes((int)(r.where), (char *)s.undo_char + r.char_storage, (int)(r.insert_length));}
		...
		{
			this.undo.eundo((int)(where), (int)(0), (int)(length));
		}

		public void MakeundoDelete(int where, int length)
		{
			int i;
			uint* p = this.undo.eundo((int)(where), (int)(length), (int)(0));
			if ((p) != null) {
for (i = (int)(0); (i) < (length); ++i) {p[i] = (char)(this._string_.RuneAt((int)(where + i)));}}
		...
		{
			int i;
			uint* p = this.undo.eundo((int)(where), (int)(old_length), (int)(new_length));
			if ((p) != null) {
for (i = (int)(0); (i) < (old_length); ++i) {p[i] = (char)(this._string_.RuneAt((int)(where + i)));}}

		}

		public void ClearState(int type, Nuklear.NkPluginFilter filter)
		{
		...
		public void InitFixed(void * memory, ulong size)
		{
			...
			ClearState((int)(Nuklear.NK_TEXT_EDIT_SINGLE_LINE), null);
