// Generated by Sichem at 2/3/2018 2:37:08 AM
...
namespace NuklearSharp
{
	unsafe partial class Nuklear
	{
		...
		public static void* nk_draw_vertex(void* dst, nk_convert_config config, nk_vec2 pos, nk_vec2 uv, nk_colorf color)
		{
			...
			while (nk_draw_vertex_layout_element_is_end_of_layout((nk_draw_vertex_layout_element) (*elem_iter)) == 0)
			{
			...
			float font_height, nk_color fg)
		{
			...
			while (((text_len) < (len)) && ((glyph_len) != 0))
			{
				...
				nk_draw_list_push_rect_uv(list, (nk_vec2) (nk_vec2_((float) (gx), (float) (gy))),
					(nk_vec2) (nk_vec2_((float) (gx + gw), (float) (gy + gh))),
					(nk_vec2) (nk_vec2_((float) (g.uv_x[0]), (float) (g.uv_y[0]))),
					(nk_vec2) (nk_vec2_((float) (g.uv_x[1]), (float) (g.uv_y[1]))), (nk_color) (fg));
				text_len += (int) (glyph_len);
				x += (float) (char_width);
		...
		public static int nk_convert(nk_context ctx, nk_buffer cmds, nk_buffer vertices, nk_buffer elements,
		...
		public static void* nk_font_atlas_bake(nk_font_atlas atlas, int* width, int* height, int fmt)
		{
			...
			if (nk_font_bake_pack(baker, &img_size, width, height, ref atlas.custom, atlas.config, (int) (atlas.font_num)) == 0)
				goto failed;
			atlas.pixel = CRuntime.malloc((ulong) (img_size));
			if (atlas.pixel == null) goto failed;
			nk_font_bake(baker, atlas.pixel, (int) (*width), (int) (*height), atlas.glyphs, (int) (atlas.glyph_count),
				atlas.config, (int) (atlas.font_num));
		...
		public static int nk_do_selectable(ref uint state, nk_command_buffer _out_, nk_rect bounds, char* str, int len,
			uint align, int* value, nk_style_selectable style, nk_input _in_, nk_user_font font)
		{
			int old_value;
			...
			if ((nk_button_behavior(ref state, (nk_rect) (touch), _in_, (int) (NK_BUTTON_DEFAULT))) != 0)
				*value = *value != 0 ? 0 : 1;
			if ((style.draw_begin) != null) style.draw_begin(_out_, (nk_handle) (style.userdata));
			nk_draw_selectable(_out_, (uint) (state), style, (int) (*value), &bounds, null, null, str, (int) (len),
				(uint) (align), font);
			if ((style.draw_end) != null) style.draw_end(_out_, (nk_handle) (style.userdata));
			...
			uint align, int* value, nk_image img, nk_style_selectable style, nk_input _in_, nk_user_font font)
		{
			...
			icon.h -= (float) (2*style.image_padding.y);
			if ((style.draw_begin) != null) style.draw_begin(_out_, (nk_handle) (style.userdata));
			nk_draw_selectable(_out_, (uint) (state), style, (int) (*value), &bounds, &icon, img, str, (int) (len),
				(uint) (align), font);
			if ((style.draw_end) != null) style.draw_end(_out_, (nk_handle) (style.userdata));
			return old_value != *value ? 1 : 0;
		}
		...
		public static int nk_tree_state_base(nk_context ctx, int type, nk_image img, char* title, ref int state)
		{
			...
			nk_vec2 item_spacing = new nk_vec2();
			nk_rect header = new nk_rect();
			header.x = (float) (header.y = (float) (header.w = (float) (header.h = (float) (0))));
			nk_rect sym = new nk_rect();
			sym.x = (float) (sym.y = (float) (sym.w = (float) (sym.h = (float) (0))));
			nk_text text = new nk_text();
			uint ws = (uint) (0);
			int widget_state;
			if (((ctx == null) || (ctx.current == null)) || (ctx.current.layout == null)) return (int) (0);
		...
		public static int nk_selectable_text(nk_context ctx, char* str, int len, uint align, int* value)
		{
			nk_window win;
			nk_panel layout;
			nk_input _in_;
			...
			return
				(int)
					(nk_do_selectable(ref ctx.last_widget_state, win.buffer, (nk_rect) (bounds), str, (int) (len), (uint) (align),
						value, style.selectable, _in_, style.font));
		}

		public static int nk_selectable_image_text(nk_context ctx, nk_image img, char* str, int len, uint align, int* value)
		{
			nk_window win;
			nk_panel layout;
			nk_input _in_;
			...
			return
				(int)
					(nk_do_selectable_image(ref ctx.last_widget_state, win.buffer, (nk_rect) (bounds), str, (int) (len), (uint) (align),
						value, img, style.selectable, _in_, style.font));
		}
		...
		public static int nk_selectable_label(nk_context ctx, char* str, uint align, int* value)
		{
			return (int) (nk_selectable_text(ctx, str, (int) (nk_strlen(str)), (uint) (align), value));
		}

		public static int nk_selectable_image_label(nk_context ctx, nk_image img, char* str, uint align, int* value)
		{
		...
		public static void nk_property_int(nk_context ctx, char* name, int min, int* val, int max, int step,
			float inc_per_pixel)
		{
		...
		public static void nk_property_float(nk_context ctx, char* name, float min, float* val, float max, float step,
			float inc_per_pixel)
		{
			nk_property_variant variant = new nk_property_variant();
			if ((((ctx == null) || (ctx.current == null)) || (name == null)) || (val == null)) return;
		...
		public static void nk_property_double(nk_context ctx, char* name, double min, double* val, double max, double step,
			float inc_per_pixel)
		{
			nk_property_variant variant = new nk_property_variant();
			if ((((ctx == null) || (ctx.current == null)) || (name == null)) || (val == null)) return;
			...
			float min_value, float max_value)
		{
			...
			nk_style_item background;
			nk_rect bounds = new nk_rect();
			bounds.x = (float) (bounds.y = (float) (bounds.w = (float) (bounds.h = (float) (0))));
			if (((ctx == null) || (ctx.current == null)) || (ctx.current.layout == null)) return (int) (0);
		...
		public static uint nk_chart_push_column(nk_context ctx, nk_window win, nk_chart chart, float value, int slot)
		{
			...
			item.x = (float) (item.y = (float) (item.w = (float) (item.h = (float) (0))));
		...
		public static void nk_contextual_end(nk_context ctx)
		{
			...
			{
				nk_rect body = new nk_rect();
				body.x = (float) (body.y = (float) (body.w = (float) (body.h = (float) (0))));
		...
		public static int nk_combo_begin_image(nk_context ctx, nk_image img, nk_vec2 size)
		{
			...
			{
				nk_rect bounds = new nk_rect();
				bounds.x = (float) (bounds.y = (float) (bounds.w = (float) (bounds.h)));
				nk_rect content = new nk_rect();
				nk_rect button = new nk_rect();
				int sym;
				if ((ctx.last_widget_state & NK_WIDGET_STATE_HOVER) != 0) sym = (int) (style.combo.sym_hover);
			...
			int* value, nk_style_selectable style, nk_input _in_, nk_user_font font)
		{
			fixed (char* ptr = str)
			{
				return nk_do_selectable(ref state, _out_, bounds, ptr, (int) str.Length, align, value, style, _in_, font);
			}
		}
			...
			uint align, int* value, nk_image img, nk_style_selectable style, nk_input _in_, nk_user_font font)
		{
			fixed (char* ptr = str)
			{
				return nk_do_selectable_image(ref state, _out_, bounds, ptr, (int) str.Length, align, value, img, style, _in_, font);
			}
		}
		...
		public static int nk_selectable_text(nk_context ctx, string str, uint align, int* value)
		{
			fixed (char* ptr = str)
			{
				return nk_selectable_text(ctx, ptr, (int) str.Length, align, value);
			}
		}

		public static int nk_selectable_image_text(nk_context ctx, nk_image img, string str, uint align, int* value)
		{
			fixed (char* ptr = str)
			{
				return nk_selectable_image_text(ctx, img, ptr, (int) str.Length, align, value);
			}
		}
		...
		public static int nk_selectable_label(nk_context ctx, string str, int* value)
		{
			fixed (char* ptr = str)
			{
				return nk_selectable_label(ctx, ptr, (uint) str.Length, value);
			}
		}

		public static int nk_selectable_image_label(nk_context ctx, nk_image img, string str, int* value)
		{
			fixed (char* ptr = str)
			{
				return nk_selectable_image_label(ctx, img, ptr, (uint) str.Length, value);
			}
		}
		...
		public static void nk_property_int(nk_context ctx, string name, int* val, int max, int step, float inc_per_pixel)
		{
			fixed (char* ptr = name)
			{
				nk_property_int(ctx, ptr, (int) name.Length, val, max, step, inc_per_pixel);
			}
		}
