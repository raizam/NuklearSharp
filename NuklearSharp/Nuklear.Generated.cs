// Generated by Sichem at 2/3/2018 9:36:14 PM
...
namespace NuklearSharp
{
	unsafe partial class Nuklear
	{
			...
			nk_font_config config)
		{
			...
			nk_decode_85((byte*) (compressed_data), data_base85);
		...
		public static void nk_font_bake_custom_data(void* img_memory, int img_width, int img_height, nk_recti img_dst,
			byte[] texture_data_mask, int tex_width, int tex_height, char white, char black)
		{
			fixed (byte* ptr = texture_data_mask)
			{
				nk_font_bake_custom_data(img_memory, img_width, img_height, img_dst, ptr, tex_width, tex_height,
					white, black);
			}
		}
		...
		public static int nk_tree_base(nk_context ctx, int type, nk_image img, string title, char* hash, int len, int line)
		{
			fixed (char* ptr = title)
			{
		...
		public static int nk_tree_push_hashed(nk_context ctx, int type, string title, char* hash, int len, int line)
		{
			fixed (char* ptr = title)
			{
		...
		public static int nk_tree_image_push_hashed(nk_context ctx, int type, nk_image img, string title, char* hash, int len,
			int seed)
		{
			fixed (char* ptr = title)
			{
