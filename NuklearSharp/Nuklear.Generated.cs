// Generated by Sichem at 1/31/2018 1:04:18 AM
...
namespace NuklearSharp
{
	unsafe partial class Nuklear
	{
		...
		public class nk_mouse_button
		{
			public int down;
			public uint clicked;
			public nk_vec2 clicked_pos = new nk_vec2();
		}
		...
		public class nk_config_stack_style_item
		{
			...
			public PinnedArray<nk_config_stack_style_item_element> elements =
				new PinnedArray<nk_config_stack_style_item_element>(16);
		}
		...
		public class nk_rp_context
		{
			...
			public PinnedArray<nk_rp_node> extra = new PinnedArray<nk_rp_node>(2);
		}
		...
		public static void nk_stroke_rect(nk_command_buffer b, nk_rect rect, float rounding, float line_thickness, nk_color c)
		{
			...
			if ((b.use_clipping) != 0)
			{
				nk_rect* clip = &b.clip;
				if (
					!(!(((((clip->x) > (rect.x + rect.w)) || ((clip->x + clip->w) < (rect.x))) || ((clip->y) > (rect.y + rect.h))) ||
					    ((clip->y + clip->h) < (rect.y))))) return;
			}
			...
			float line_thickness, nk_color c)
		{
			...
			if ((b.use_clipping) != 0)
			{
				...
				if (
					...
					(!((((clip->x) <= (x2)) && ((x2) < (clip->x + clip->w))) && (((clip->y) <= (y2)) && ((y2) < (clip->y + clip->h))))))
					return;
			}
		...
		public static void* nk_draw_vertex(void* dst, nk_convert_config config, nk_vec2 pos, nk_vec2 uv, nk_colorf color)
		{
			...
			var elem_iter = 0;
			while (nk_draw_vertex_layout_element_is_end_of_layout((config.vertex_layout[elem_iter])) == 0)
			{
				void* address = (void*) ((sbyte*) (dst) + config.vertex_layout[elem_iter].offset);
				switch (config.vertex_layout[elem_iter].attribute)
				{
					...
					case NK_VERTEX_POSITION:
						nk_draw_vertex_element(address, &pos.x, (int) (2), (int) (config.vertex_layout[elem_iter].format));
						break;
					case NK_VERTEX_TEXCOORD:
						nk_draw_vertex_element(address, &uv.x, (int) (2), (int) (config.vertex_layout[elem_iter].format));
						break;
					case NK_VERTEX_COLOR:
						nk_draw_vertex_color(address, &color.r, (int) (config.vertex_layout[elem_iter].format));
						break;
				}
				elem_iter++;
			}
		...
		public static int nk_convert(nk_context ctx, nk_buffer<nk_command_base> cmds, nk_buffer<byte> vertices,
			nk_buffer<ushort> elements, nk_convert_config config)
		{
			uint res = (uint) (NK_CONVERT_SUCCESS);

			if ((((((ctx == null) || (cmds == null)) || (vertices == null)) || (elements == null)) || (config == null)) ||
			    (config.vertex_layout == null)) return (int) (0);
			...
			foreach (var cmd in top_window.buffer.commands)
			{
				...
				switch (cmd.header.type)
				{
					...
					case NK_COMMAND_POLYGON:
					{
						...
						{
							nk_vec2 pnt = (nk_vec2) (nk_vec2_((float) (p.points.x), (float) (p.points.y)));
					...
					case NK_COMMAND_TEXT:
					{
						...
						nk_draw_list_add_text(ctx.draw_list, t.font,
							(nk_rect) (nk_rect_((float) (t.x), (float) (t.y), (float) (t.w), (float) (t.h))), t._string_, (float) (t.height),
							(nk_color) (t.foreground));
					}
						break;
		...
		public static void nk_rp_init_target(nk_rp_context context, int width, int height, nk_rp_node* nodes, int num_nodes)
		{
			...
			context.active_head = (nk_rp_node*) context.extra;
			...
			((nk_rp_node*) context.extra)[0].x = (ushort) (0);
			((nk_rp_node*) context.extra)[0].y = (ushort) (0);
			((nk_rp_node*) context.extra)[0].next = (nk_rp_node*) context.extra + 1;
			((nk_rp_node*) context.extra)[1].x = ((ushort) (width));
			((nk_rp_node*) context.extra)[1].y = (ushort) (65535);
			((nk_rp_node*) context.extra)[1].next = null;
		}
			...
			int padding)
		{
			...
			{
				if (context != null) if (nodes != null) CRuntime.free(nodes);
				return (int) (0);
			}
				...
				for (j = (int) (0); (j) < (ranges[i].num_chars); ++j)
				{
					...
					if ((r->was_packed) != 0)
					{
						...
						nk_tt_MakeGlyphBitmapSubpixel(info, spc.pixels + r->x + r->y*spc.stride_in_bytes,
							...
							(float) (scale*(float) (spc.h_oversample)), (float) (scale*(float) (spc.v_oversample)), (float) (0), (float) (0),
							(int) (glyph));
		...
		{
			uint* ranges = stackalloc uint[11];
			ranges[0] = (uint) (0x0020);
			ranges[1] = (uint) (0x00FF);
			ranges[2] = (uint) (0x3000);
			ranges[3] = (uint) (0x30FF);
			ranges[4] = (uint) (0x31F0);
			ranges[5] = (uint) (0x31FF);
			ranges[6] = (uint) (0xFF00);
			ranges[7] = (uint) (0xFFEF);
			ranges[8] = (uint) (0x4e00);
			ranges[9] = (uint) (0x9FAF);
			ranges[10] = (uint) (0);
		...
		{
			uint* ranges = stackalloc uint[9];
			ranges[0] = (uint) (0x0020);
			ranges[1] = (uint) (0x00FF);
			ranges[2] = (uint) (0x0400);
			ranges[3] = (uint) (0x052F);
			ranges[4] = (uint) (0x2DE0);
			ranges[5] = (uint) (0x2DFF);
			ranges[6] = (uint) (0xA640);
			ranges[7] = (uint) (0xA69F);
			ranges[8] = (uint) (0);
		...
		public static int nk_font_bake_pack(nk_font_baker baker, ulong* image_memory, int* width, int* height,
			nk_recti* custom, nk_font_config* config_list, int count)
		{
			...
			nk_tt_PackBegin(baker.spc, null, (int) (*width), (int) (max_height), (int) (0), (int) (1));
			{
					...
					config_iter = config_iter->next)
				{
					...
					do
					{
						...
						n =
							(int) (nk_tt_PackFontRangesGatherRects(baker.spc, &tmp->info, tmp->ranges, (int) (tmp->range_count), tmp->rects));
						nk_rp_pack_rects((nk_rp_context) (baker.spc.pack_info), tmp->rects, (int) (n));
						for (i = (int) (0); (i) < (n); ++i)
						{
							if ((tmp->rects[i].was_packed) != 0)
								*height =
									(int) ((*height) < (tmp->rects[i].y + tmp->rects[i].h) ? (tmp->rects[i].y + tmp->rects[i].h) : (*height));
						}
					} while ((it = it->n) != config_iter);
				}
			}
		...
		public static void nk_font_bake_custom_data(void* img_memory, int img_width, int img_height, nk_recti img_dst,
			StringView texture_data_mask, int tex_width, int tex_height, sbyte white, sbyte black)
		{
			byte* pixels;
			int y = (int) (0);
			int x = (int) (0);
		...
		public static float nk_font_text_width(nk_font font, float height, StringView text)
		{
			char unicode;
			int text_len = (int) (0);
			...
			if (((font == null) || (text == null))) return (float) (0);
			scale = (float) (height/font.info.height);
			glyph_len = (int) (text_len = (int) (nk_utf_decode(text, &unicode, text.Length)));
			...
			while ((text_len <= text.Length) && ((glyph_len) != 0))
			{
				...
				glyph_len = (int) (nk_utf_decode(text + text_len, &unicode, (int) (text.Length - text_len)));
			...
			nk_baked_font* baked_font, nk_handle atlas)
		{
			...
			font.handle.WidthDelegate = font.text_width;
		...
		public static nk_font_config nk_font_config_(float pixel_height)
		{
			...
			nk_zero(&cfg, (ulong) (sizeof (nk_font_config)));
			cfg.ttf_blob = null;
		...
		public static nk_font nk_font_atlas_add(nk_font_atlas atlas, nk_font_config* config)
		{
			...
			cfg = (nk_font_config*) (CRuntime.malloc((ulong) (sizeof (nk_font_config))));
			nk_memcopy(cfg, config, (ulong) (sizeof (nk_font_config)));
			cfg->n = cfg;
			cfg->p = cfg;
		...
		public static nk_font nk_font_atlas_add_compressed_base85(nk_font_atlas atlas, sbyte* data_base85, float height,
			nk_font_config* config)
		{
			int compressed_size;
			void* compressed_data;
			if ((((((atlas == null) || (data_base85 == null)))))) return null;
			compressed_size = (int) (((CRuntime.strlen(data_base85) + 4)/5)*4);
		...
		{
			return nk_font_atlas_add_compressed_base85(atlas, nk_proggy_clean_ttf_compressed_data_base85, (float) (pixel_height),
				config);
		}
		...
		public static int nk_textedit_locate_coord(nk_text_edit edit, float x, float y, nk_user_font font, float row_height)
		{
			...
			int n = (int) (edit._string_.Length);
			...
			nk_user_font font, float row_height)
		{
			...
			int z = (int) (state._string_.Length);
			int i = (int) (0);
			int first;
		...
		{
			int n = (int) (state._string_.Length);
		...
		public static void nk_textedit_delete(nk_text_edit state, int where, int len)
		{
			...
			nk_str_delete_runes(ref state._string_, (int) (where), (int) (len));
			state.has_preferred_x = (byte) (0);
		}
		...
		{
			int len = (int) (state._string_.Length);
			int c = (int) (state.cursor + 1);
		...
		public static void nk_textedit_key(nk_text_edit state, int key, int shift_mod, nk_user_font font, float row_height)
		{
			...
			switch (key)
			{
				...
				case NK_KEY_TEXT_END:
					...
					{
						nk_textedit_prep_selection_at_cursor(state);
						state.cursor = (int) (state.select_end = (int) (state._string_.Length));
						state.has_preferred_x = (byte) (0);
					}
					else
					{
						state.cursor = (int) (state._string_.Length);
				...
				case NK_KEY_TEXT_LINE_START:
				{
					if ((shift_mod) != 0)
					{
						...
						nk_textedit_clamp(state);
						nk_textedit_prep_selection_at_cursor(state);
						if (((state._string_.Length) != 0) && ((state.cursor) == (state._string_.Length))) --state.cursor;
						nk_textedit_find_charpos(&find, state, (int) (state.cursor), (int) (state.single_line), font, (float) (row_height));
		...
		public static void nk_textedit_undo(nk_text_edit state)
		{
			...
			if ((u.delete_length) != 0)
			{
				...
				nk_str_delete_runes(ref state._string_, (int) (u.where), (int) (u.delete_length));
			}

			if ((u.insert_length) != 0)
			{
				nk_str_insert_text_runes(ref state._string_, (int) (u.where), (char*) s.undo_char + u.char_storage,
					(int) (u.insert_length));
		...
		public static void nk_textedit_redo(nk_text_edit state)
		{
			...
			if ((r.delete_length) != 0)
			{
				...
				nk_str_delete_runes(ref state._string_, (int) (r.where), (int) (r.delete_length));
			}

			if ((r.insert_length) != 0)
			{
				nk_str_insert_text_runes(ref state._string_, (int) (r.where), (char*) s.undo_char + r.char_storage,
					(int) (r.insert_length));
			}
		...
		public static void nk_textedit_select_all(nk_text_edit state)
		{
			...
			state.select_end = (int) (state._string_.Length);
		}

		public static void nk_textedit_free(nk_text_edit state)
		{
			if (state == null) return;
			state._string_ = StringView.empty;
		}

		public static void nk_widget_text(nk_command_buffer o, nk_rect b, StringView _string_, nk_text* t, uint a,
			nk_user_font f)
		{
			...
			text_width = (float) (f.width((float) (f.height), _string_));
			...
			nk_draw_text(o, (nk_rect) (label), _string_, f, (nk_color) (t->background), (nk_color) (t->text));
		}

		public static void nk_widget_text_wrap(nk_command_buffer o, nk_rect b, StringView _string_, nk_text* t, nk_user_font f)
		{
			float width;
			int glyphs = (int) (0);
			int fitting = (int) (0);
			...
			fitting = (int) (nk_text_clamp(f, _string_, (float) (line.w), &glyphs, &width, seperator, 1));
			while (done < _string_.Length)
			{
				if ((fitting == 0) || ((line.y + line.h) >= (b.y + b.h))) break;
				nk_widget_text(o, (nk_rect) (line), new StringView(_string_, done, fitting), &text, (uint) (NK_TEXT_LEFT), f);
				done += (int) (fitting);
				line.y += (float) (f.height + 2*t->padding.y);
				fitting = (int) (nk_text_clamp(f, _string_ + done, (float) (line.w), &glyphs, &width, seperator, 1));
			}
		}
			...
			nk_color foreground, float border_width, nk_user_font font)
		{
			switch (type)
			{
				...
				case NK_SYMBOL_MINUS:
				{
					...
					nk_widget_text(_out_, (nk_rect) (content), X, &text, (uint) (NK_TEXT_CENTERED), font);
				}
					break;
		...
		public static int nk_do_button(uint* state, nk_command_buffer _out_, nk_rect r, nk_style_button style, nk_input _in_,
			int behavior, nk_rect* content)
		{
		...
		public static void nk_draw_button_text(nk_command_buffer _out_, nk_rect* bounds, nk_rect* content, uint state,
			nk_style_button style, StringView txt, uint text_alignment, nk_user_font font)
		{
			nk_text text = new nk_text();
			nk_style_item* background;
			...
			text.padding = (nk_vec2) (nk_vec2_((float) (0), (float) (0)));
			nk_widget_text(_out_, (nk_rect) (*content), txt, &text, (uint) (text_alignment), font);
		}

		public static int nk_do_button_text(uint* state, nk_command_buffer _out_, nk_rect bounds, StringView _string_,
			uint align, int behavior, nk_style_button style, nk_input _in_, nk_user_font font)
		{
			...
			nk_draw_button_text(_out_, &bounds, &content, (uint) (*state), style, _string_, (uint) (align), font);
		...
		public static int nk_do_button_symbol(uint* state, nk_command_buffer _out_, nk_rect bounds, int symbol, int behavior,
			nk_style_button style, nk_input _in_, nk_user_font font)
		{
			int ret;
			nk_rect content = new nk_rect();
		...
		public static int nk_do_button_image(uint* state, nk_command_buffer _out_, nk_rect bounds, nk_image img, int b,
		...
		public static void nk_draw_button_text_symbol(nk_command_buffer _out_, nk_rect* bounds, nk_rect* label,
			nk_rect* symbol, uint state, nk_style_button style, StringView str, int type, nk_user_font font)
		{
			nk_color sym = new nk_color();
			nk_text text = new nk_text();
			nk_style_item* background;
			...
			nk_draw_symbol(_out_, (int) (type), (nk_rect) (*symbol), (nk_color) (style.text_background), (nk_color) (sym),
				(float) (0), font);
			nk_widget_text(_out_, (nk_rect) (*label), str, &text, (uint) (NK_TEXT_CENTERED), font);
		}

		public static int nk_do_button_text_symbol(uint* state, nk_command_buffer _out_, nk_rect bounds, int symbol,
			StringView str, uint align, int behavior, nk_style_button style, nk_user_font font, nk_input _in_)
		{
			int ret;
			nk_rect tri = new nk_rect();
			tri.x = (float) (tri.y = (float) (tri.w = (float) (tri.h = (float) (0))));
			nk_rect content = new nk_rect();
			...
			if ((style.draw_begin) != null) style.draw_begin(_out_, (nk_handle) (style.userdata));
			nk_draw_button_text_symbol(_out_, &bounds, &content, &tri, (uint) (*state), style, str, (int) (symbol), font);
			if ((style.draw_end) != null) style.draw_end(_out_, (nk_handle) (style.userdata));
			return (int) (ret);
		}

		public static void nk_draw_button_text_image(nk_command_buffer _out_, nk_rect* bounds, nk_rect* label, nk_rect* image,
			uint state, nk_style_button style, StringView str, nk_user_font font, nk_image* img)
		{
			nk_text text = new nk_text();
			nk_style_item* background;
			background = nk_draw_button(_out_, bounds, (uint) (state), style);
		...
		public static int nk_do_button_text_image(uint* state, nk_command_buffer _out_, nk_rect bounds, nk_image img,
			StringView str, uint align, int behavior, nk_style_button style, nk_user_font font, nk_input _in_)
		{
			int ret;
			...
			if ((style.draw_begin) != null) style.draw_begin(_out_, (nk_handle) (style.userdata));
			nk_draw_button_text_image(_out_, &bounds, &content, &icon, (uint) (*state), style, str, font, &img);
			if ((style.draw_end) != null) style.draw_end(_out_, (nk_handle) (style.userdata));
			return (int) (ret);
		}
		...
		public static void nk_draw_checkbox(nk_command_buffer _out_, uint state, nk_style_toggle style, int active,
			nk_rect* label, nk_rect* selector, nk_rect* cursors, StringView _string_, nk_user_font font)
		{
			nk_style_item* background;
			...
			nk_widget_text(_out_, (nk_rect) (*label), _string_, &text, (uint) (NK_TEXT_LEFT), font);
		}
		...
		public static int nk_do_toggle(uint* state, nk_command_buffer _out_, nk_rect r, int* active, StringView str, int type,
			nk_style_toggle style, nk_input _in_, nk_user_font font)
		{
			...
			*active = (int) (nk_toggle_behavior(_in_, (nk_rect) (bounds), state, (int) (*active)));
			...
			{
				nk_draw_checkbox(_out_, (uint) (*state), style, (int) (*active), &label, &select, &cursor, str, font);
			}
			else
			{
				nk_draw_option(_out_, (uint) (*state), style, (int) (*active), &label, &select, &cursor, str, font);
			}
		...
		public static void nk_draw_selectable(nk_command_buffer _out_, uint state, nk_style_selectable style, int active,
			nk_rect* bounds, nk_rect* icon, nk_image* img, StringView _string_, uint align, nk_user_font font)
		{
			nk_style_item* background;
			nk_text text = new nk_text();
			...
			nk_widget_text(_out_, (nk_rect) (*bounds), _string_, &text, (uint) (align), font);
		}

		public static int nk_do_selectable(uint* state, nk_command_buffer _out_, nk_rect bounds, StringView str, uint align,
			int* value, nk_style_selectable style, nk_input _in_, nk_user_font font)
		{
			int old_value;
			nk_rect touch = new nk_rect();
			if (((((((state == null) || (_out_ == null)) || (str == null))) || (value == null)) || (style == null)) ||
			...
			if ((nk_button_behavior(state, (nk_rect) (touch), _in_, (int) (NK_BUTTON_DEFAULT))) != 0)
				*value = *value != 0 ? 0 : 1;
			if ((style.draw_begin) != null) style.draw_begin(_out_, (nk_handle) (style.userdata));
			nk_draw_selectable(_out_, (uint) (*state), style, (int) (*value), &bounds, null, null, str, (uint) (align), font);
			if ((style.draw_end) != null) style.draw_end(_out_, (nk_handle) (style.userdata));
			return old_value != *value ? 1 : 0;
		}

		public static int nk_do_selectable_image(uint* state, nk_command_buffer _out_, nk_rect bounds, StringView str,
			uint align, int* value, nk_image* img, nk_style_selectable style, nk_input _in_, nk_user_font font)
		{
			int old_value;
			nk_rect touch = new nk_rect();
			nk_rect icon = new nk_rect();
			...
			icon.h -= (float) (2*style.image_padding.y);
			if ((style.draw_begin) != null) style.draw_begin(_out_, (nk_handle) (style.userdata));
			nk_draw_selectable(_out_, (uint) (*state), style, (int) (*value), &bounds, &icon, img, str, (uint) (align), font);
			if ((style.draw_end) != null) style.draw_end(_out_, (nk_handle) (style.userdata));
			return old_value != *value ? 1 : 0;
		}

		public static float nk_slider_behavior(uint* state, nk_rect* logical_cursor, nk_rect* visual_cursor, nk_input _in_,
		...
		public static float nk_do_slider(uint* state, nk_command_buffer _out_, nk_rect bounds, float min, float val, float max,
			float step, nk_style_slider style, nk_input _in_, nk_user_font font)
		{
			float slider_range;
			float slider_min;
			float slider_max;
			...
			if ((style.show_buttons) != 0)
			{
				...
				if (
					(nk_do_button_symbol(&ws, _out_, (nk_rect) (button), (int) (style.dec_symbol), (int) (NK_BUTTON_DEFAULT),
						style.dec_button, _in_, font)) != 0) val -= (float) (step);
				button.x = (float) ((bounds.x + bounds.w) - button.w);
				if (
					(nk_do_button_symbol(&ws, _out_, (nk_rect) (button), (int) (style.inc_symbol), (int) (NK_BUTTON_DEFAULT),
			...
			slider_value =
				(float)
					(nk_slider_behavior(state, &logical_cursor, &visual_cursor, _in_, (nk_rect) (bounds), (float) (slider_min),
		...
		public static ulong nk_progress_behavior(uint* state, nk_input _in_, nk_rect r, nk_rect cursor, ulong max, ulong value,
			int modifiable)
		{
		...
		public static ulong nk_do_progress(uint* state, nk_command_buffer _out_, nk_rect bounds, ulong value, ulong max,
			int modifiable, nk_style_progress style, nk_input _in_)
		{
			...
			prog_value =
				(ulong)
					(nk_progress_behavior(state, _in_, (nk_rect) (bounds), (nk_rect) (cursor), (ulong) (max), (ulong) (prog_value),
						(int) (modifiable)));
		...
		public static float nk_scrollbar_behavior(uint* state, nk_input _in_, int has_scrolling, nk_rect* scroll,
				...
				*state = (uint) (NK_WIDGET_STATE_ACTIVE);
				...
				else
				{
					...
					_in_.mouse.buttons[NK_BUTTON_LEFT].clicked_pos.x = (float) (cursor_x + cursor->w/2.0f);
			          ...
			          ((has_scrolling) != 0)) ||
			         ((nk_button_behavior(&ws, (nk_rect) (*empty0), _in_, (int) (NK_BUTTON_DEFAULT))) != 0))
			{
				if ((o) == (NK_VERTICAL))
					scroll_offset = (float) ((0) < (scroll_offset - scroll->h) ? (scroll_offset - scroll->h) : (0));
			          ...
			          ((has_scrolling) != 0)) ||
			         ((nk_button_behavior(&ws, (nk_rect) (*empty1), _in_, (int) (NK_BUTTON_DEFAULT))) != 0))
			{
				if ((o) == (NK_VERTICAL))
					scroll_offset =
						(float)
		...
		public static float nk_do_scrollbarv(uint* state, nk_command_buffer _out_, nk_rect scroll, int has_scrolling,
			...
			nk_user_font font)
		{
			...
			if ((style.show_buttons) != 0)
			{
				...
				if (
					(nk_do_button_symbol(&ws, _out_, (nk_rect) (button), (int) (style.dec_symbol), (int) (NK_BUTTON_REPEATER),
						style.dec_button, _in_, font)) != 0) offset = (float) (offset - scroll_step);
				button.y = (float) (scroll.y + scroll.h - button.h);
				if (
					(nk_do_button_symbol(&ws, _out_, (nk_rect) (button), (int) (style.inc_symbol), (int) (NK_BUTTON_REPEATER),
			...
			scroll_offset =
				(float)
					(nk_scrollbar_behavior(state, _in_, (int) (has_scrolling), &scroll, &cursor, &empty_north, &empty_south,
		...
		public static float nk_do_scrollbarh(uint* state, nk_command_buffer _out_, nk_rect scroll, int has_scrolling,
			float offset, float target, float step, float button_pixel_inc, nk_style_scrollbar style, nk_input _in_,
			nk_user_font font)
		{
			nk_rect cursor = new nk_rect();
			...
			scroll_offset =
				(float)
					(nk_scrollbar_behavior(state, _in_, (int) (has_scrolling), &scroll, &cursor, &empty_west, &empty_east,
		...
		public static void nk_edit_draw_text(nk_command_buffer _out_, nk_style_edit style, float pos_x, float pos_y,
			float x_offset, StringView text, float row_height, nk_user_font font, nk_color background, nk_color foreground,
			int is_selected)
		{
			if ((((text == null) || (text.Length == 0)) || (_out_ == null)) || (style == null)) return;
			{
				int glyph_len = (int) (0);
				char unicode = (char) 0;
				int text_len = (int) (0);
		...
		public static uint nk_do_edit(uint* state, nk_command_buffer _out_, nk_rect bounds, uint flags, NkPluginFilter filter,
			nk_text_edit edit, nk_style_edit style, nk_input _in_, nk_user_font font)
		{
			...
			if ((prev_state == 0) && ((edit.active) != 0))
			{
				...
				{
					edit.cursor = (int) (edit._string_.Length);
					_in_ = null;
				}
			}
			...
			if (((edit.active) != 0) && ((_in_) != null))
			{
				...
				}
				{
					...
					if ((((copy) != 0) || ((cut) != 0)) && ((flags & NK_EDIT_CLIPBOARD) != 0))
					{
						...
						if ((edit.clip.CopyDelegate) != null) edit.clip.copy((nk_handle) (edit.clip.userdata), text, (int) (end - begin));
			...
			{
				StringView text = nk_str_get_const(edit._string_);
				...
				if ((edit.active) != 0)
				{
					...
					StringView cursor_ptr = null;
					StringView select_begin_ptr = null;
					StringView select_end_ptr = null;
					...
					if (((text) != null) && ((len) != 0))
					{
						...
						int glyphs = (int) (0);
						int row_begin = (int) (0);
						glyph_len = (int) (nk_utf_decode(text, &unicode, text.Length));
						...
						while (((text_len) < (len)) && ((glyph_len) != 0))
						{
							if ((cursor_ptr == null) && ((glyphs) == (edit.cursor)))
							{
								...
								row_size =
									(nk_vec2)
										(nk_text_calculate_text_bounds(font, text + row_begin, (float) (row_height), &remaining, &out_offset,
											&glyph_offset, (int) (NK_STOP_ON_NEW_LINE)));
						...
						if ((cursor_ptr == null) && ((edit.cursor) == (edit._string_.Length)))
						{
					...
					}
					{
						...
						if ((flags & NK_EDIT_MULTILINE) != 0)
						{
							...
							edit.scrollbar.y =
								(float)
									(nk_do_scrollbarv(&ws, _out_, (nk_rect) (scroll), (int) (0), (float) (scroll_offset), (float) (scroll_target),
					...
					}
					{
						...
						{
							StringView begin = nk_str_get_const(edit._string_);
						...
						else
						{
							...
							if (((edit.select_start != edit.select_end) && ((selection_end) < (edit._string_.Length))))
							{
								StringView begin = select_end_ptr;
								StringView end = nk_str_get_const(edit._string_) + nk_str_len_char(edit._string_);
								nk_edit_draw_text(_out_, style, (float) (area.x - edit.scrollbar.x),
						...
						if ((edit.select_start) == (edit.select_end))
						{
							if (((edit.cursor) >= (nk_str_len(edit._string_))) || (((cursor_ptr) != null) && (cursor_ptr[0] == ('\n'))))
							{
								nk_rect cursor = new nk_rect();
		...
		public static void nk_drag_behavior(uint* state, nk_input _in_, nk_rect drag, nk_property_variant* variant,
			float inc_per_pixel)
		{
		...
		public static void nk_property_behavior(uint* ws, nk_input _in_, nk_rect property, nk_rect label, nk_rect edit,
			nk_rect empty, int* state, nk_property_variant* variant, float inc_per_pixel)
		{
			if (((_in_) != null) && ((*state) == (NK_PROPERTY_DEFAULT)))
			{
				if ((nk_button_behavior(ws, (nk_rect) (edit), _in_, (int) (NK_BUTTON_DEFAULT))) != 0)
			...
			{
				nk_drag_behavior(ws, _in_, (nk_rect) (property), variant, (float) (inc_per_pixel));
		...
		public static void nk_draw_property(nk_command_buffer _out_, nk_style_property style, nk_rect* bounds, nk_rect* label,
			uint state, StringView name, nk_user_font font)
		{
			nk_text text = new nk_text();
			nk_style_item* background;
			if ((state & NK_WIDGET_STATE_ACTIVED) != 0)
			...
			text.padding = (nk_vec2) (nk_vec2_((float) (0), (float) (0)));
			nk_widget_text(_out_, (nk_rect) (*label), name, &text, (uint) (NK_TEXT_CENTERED), font);
		}

		public static void nk_do_property(uint* ws, nk_command_buffer _out_, nk_rect property, StringView name,
			nk_property_variant* variant, float inc_per_pixel, StringView buffer, int* len, int* state, int* cursor,
			...
			nk_text_edit text_edit, int behavior)
		{
			...
			else
			{
				switch (variant->kind)
				{
					default:
						break;
					case NK_PROPERTY_INT:
						nk_itoa(out _string_, (int) (variant->value.i));
						num_len = (int) (nk_strlen(_string_));
						break;
					case NK_PROPERTY_FLOAT:
						nk_dtoa(out _string_, (double) (variant->value.f));
						num_len = (int) (nk_string_float_limit(ref _string_, (int) (2)));
						break;
					case NK_PROPERTY_DOUBLE:
						nk_dtoa(out _string_, (double) (variant->value.d));
						num_len = (int) (nk_string_float_limit(ref _string_, (int) (2)));
						break;
				}
			...
			nk_property_behavior(ws, _in_, (nk_rect) (property), (nk_rect) (label), (nk_rect) (edit), (nk_rect) (empty), state,
				variant, (float) (inc_per_pixel));
			if ((style.draw_begin) != null) style.draw_begin(_out_, (nk_handle) (style.userdata));
			nk_draw_property(_out_, style, &property, &label, (uint) (*ws), name, (int) (name_len), font);
			if ((style.draw_end) != null) style.draw_end(_out_, (nk_handle) (style.userdata));
			if (
				(nk_do_button_symbol(ws, _out_, (nk_rect) (left), (int) (style.sym_left), (int) (behavior), style.dec_button, _in_,
					font)) != 0)
			{
				switch (variant->kind)
				{
			...
			if (
				(nk_do_button_symbol(ws, _out_, (nk_rect) (right), (int) (style.sym_right), (int) (behavior), style.inc_button, _in_,
					font)) != 0)
			{
				switch (variant->kind)
				{
			...
			{
				buffer = new StringView(dst, 0, *length);
			...
			text_edit._string_.Length = (int) (*length);
			text_edit.cursor =
				(int)
			...
			nk_do_edit(ws, _out_, (nk_rect) (edit), (uint) (NK_EDIT_FIELD | NK_EDIT_AUTO_SELECT), filters[filter], text_edit,
				style.edit, ((*state) == (NK_PROPERTY_EDIT)) ? _in_ : null, font);
			*length = (int) (text_edit._string_.Length);
				...
				*state = (int) (NK_PROPERTY_DEFAULT);
				...
				switch (variant->kind)
				{
					...
					case NK_PROPERTY_INT:
						...
						break;
					case NK_PROPERTY_FLOAT:
						nk_string_float_limit(ref buffer, (int) (2));
		...
		public static int nk_color_picker_behavior(uint* state, nk_rect* bounds, nk_rect* matrix, nk_rect* hue_bar,
		...
		public static int nk_do_color_picker(uint* state, nk_command_buffer _out_, nk_colorf* col, int fmt, nk_rect bounds,
			nk_vec2 padding, nk_input _in_, nk_user_font font)
		{
			...
			ret =
				(int)
					(nk_color_picker_behavior(state, &bounds, &matrix, &hue_bar, ((fmt) == (NK_RGBA)) ? &alpha_bar : null, col, _in_));
		...
		public static int nk_panel_has_header(uint flags, StringView title)
		{
			int active = (int) (0);
		...
		public static int nk_panel_begin(nk_context ctx, StringView title, int panel_type)
		{
			nk_input _in_;
			nk_window win;
			nk_panel layout;
			...
			layout = win.layout;
			_out_ = win.buffer;
			_in_ = (win.flags & NK_WINDOW_NO_INPUT) ? null : ctx.input;
			...
			if ((nk_panel_has_header((uint) (win.flags), title)) != 0)
			{
				...
				}
				{
					...
					if ((win.flags & NK_WINDOW_CLOSABLE) != 0)
					{
						...
						if (
							((nk_do_button_symbol(&ws, win.buffer, (nk_rect) (button), (int) (style.window.header.close_symbol),
					...
					if ((win.flags & NK_WINDOW_MINIMIZABLE) != 0)
					{
						...
						if (
							((nk_do_button_symbol(&ws, win.buffer, (nk_rect) (button),
								(int)
				...
				}
				{
					...
					nk_rect label = new nk_rect();
					label.x = (float) (label.y = (float) (label.w = (float) (label.h = (float) (0))));
...

			{
				...
				nk_unify(&clip, &win.buffer.clip, (float) (layout.clip.x), (float) (layout.clip.y),
		...
		public static void nk_panel_end(nk_context ctx)
		{
			...
			style = ctx.style;
			_out_ = window.buffer;
			_in_ = (((layout.flags & (uint) (NK_WINDOW_ROM)) != 0) || ((layout.flags & (uint) (NK_WINDOW_NO_INPUT)) != 0))
				? null
				: ctx.input;
			...
			if (((layout.flags & (uint) (NK_WINDOW_DYNAMIC)) != 0) && ((layout.flags & (uint) (NK_WINDOW_MINIMIZED)) == 0))
			{
				...
				empty_space.w = (float) (panel_padding.x + layout.border);
				empty_space.h = (float) (layout.bounds.h);
				if (((*layout.offset_y) == (0)) && ((layout.flags & NK_WINDOW_NO_SCROLLBAR) == 0))
					empty_space.w += (float) (scrollbar_size.x);
				nk_fill_rect(_out_, (nk_rect) (empty_space), (float) (0), (nk_color) (style.window.background));
				if ((*layout.offset_x != 0) && ((layout.flags & NK_WINDOW_NO_SCROLLBAR) == 0))
				{
					empty_space.x = (float) (window.bounds.x);
			    ...
			    ((window.scrollbar_hiding_timer) < (4.0f)))
			{
				...
				else scroll_has_scrolling = (int) (nk_false);
				{
					...
					scroll_offset =
						(float)
							(nk_do_scrollbarv(&state, _out_, (nk_rect) (scroll), (int) (scroll_has_scrolling), (float) (scroll_offset),
								(float) (scroll_target), (float) (scroll_step), (float) (scroll_inc), ctx.style.scrollv, _in_, style.font));
					*layout.offset_y = ((uint) (scroll_offset));
				...
				}
				{
					...
					scroll_offset =
						(float)
							(nk_do_scrollbarh(&state, _out_, (nk_rect) (scroll), (int) (scroll_has_scrolling), (float) (scroll_offset),
								(float) (scroll_target), (float) (scroll_step), (float) (scroll_inc), ctx.style.scrollh, _in_, style.font));
					*layout.offset_x = ((uint) (scroll_offset));
				}
			}
		...
		public static int nk_begin(nk_context ctx, StringView title, nk_rect bounds, uint flags)
		{
		...
		public static int nk_window_is_collapsed(nk_context ctx, StringView name)
		{
			int title_len;
			uint title_hash;
			nk_window win;
			...
			title_hash = (uint) (nk_murmur_hash(name, (uint) (NK_WINDOW_TITLE)));
			win = nk_find_window(ctx, (uint) (title_hash), name);
			if (win == null) return (int) (0);
			return (int) (win.flags & NK_WINDOW_MINIMIZED);
		}

		public static int nk_window_is_closed(nk_context ctx, StringView name)
		{
			int title_len;
			uint title_hash;
			nk_window win;
		...
		public static int nk_window_is_hidden(nk_context ctx, StringView name)
		{
			int title_len;
			uint title_hash;
			nk_window win;
		...
		public static int nk_window_is_active(nk_context ctx, StringView name)
		{
			int title_len;
			uint title_hash;
			nk_window win;
		...
		public static nk_window nk_window_find(nk_context ctx, StringView name)
		{
			int title_len;
			uint title_hash;
			title_len = (int) (nk_strlen(name));
		...
		public static void nk_window_close(nk_context ctx, StringView name)
		{
			nk_window win;
			if (ctx == null) return;
		...
		public static void nk_window_set_bounds(nk_context ctx, StringView name, nk_rect bounds)
		{
			nk_window win;
			if (ctx == null) return;
			win = nk_window_find(ctx, name);
		...
		public static void nk_window_set_position(nk_context ctx, StringView name, nk_vec2 pos)
		{
		...
		public static void nk_window_set_size(nk_context ctx, StringView name, nk_vec2 size)
		{
			nk_window win = nk_window_find(ctx, name);
			if (win == null) return;
		...
		public static void nk_window_collapse(nk_context ctx, StringView name, int c)
		{
			int title_len;
			uint title_hash;
			nk_window win;
		...
		public static void nk_window_collapse_if(nk_context ctx, StringView name, int c, int cond)
		{
			if ((ctx == null) || (cond == 0)) return;
			nk_window_collapse(ctx, name, (int) (c));
		}

		public static void nk_window_show(nk_context ctx, StringView name, int s)
		{
			int title_len;
			uint title_hash;
			nk_window win;
		...
		public static void nk_window_show_if(nk_context ctx, StringView name, int s, int cond)
		{
			if ((ctx == null) || (cond == 0)) return;
			nk_window_show(ctx, name, (int) (s));
		}

		public static void nk_window_set_focus(nk_context ctx, StringView name)
		{
			int title_len;
			uint title_hash;
			nk_window win;
		...
		public static int nk_tree_state_base(nk_context ctx, int type, nk_image* img, StringView title, int* state)
		{
			nk_window win;
			nk_panel layout;
			nk_style style;
			...
			_in_ = (!(layout.flags & NK_WINDOW_ROM)) ? ctx.input : null;
			_in_ = (((_in_) != null) && ((widget_state) == (NK_WIDGET_VALID))) ? ctx.input : null;
			if ((nk_button_behavior(&ws, (nk_rect) (header), _in_, (int) (NK_BUTTON_DEFAULT))) != 0)
...

			{
				...
				nk_do_button_symbol(&ws, win.buffer, (nk_rect) (sym), (int) (symbol), (int) (NK_BUTTON_DEFAULT), button, null,
					style.font);
				if ((img) != null)
				{
...

			{
				...
				text.padding = (nk_vec2) (nk_vec2_((float) (0), (float) (0)));
				nk_widget_text(_out_, (nk_rect) (label), title, &text, (uint) (NK_TEXT_LEFT), style.font);
			}

			if ((*state) == (NK_MAXIMIZED))
			{
				layout.at_x = (float) (header.x + (float) (*layout.offset_x) + style.tab.indent);
		...
		public static int nk_tree_base(nk_context ctx, int type, nk_image* img, StringView title, int initial_state,
			sbyte* hash, int len, int line)
		{
		...
		public static int nk_tree_state_push(nk_context ctx, int type, StringView title, int* state)
		{
			return (int) (nk_tree_state_base(ctx, (int) (type), null, title, state));
		}

		public static int nk_tree_state_image_push(nk_context ctx, int type, nk_image img, StringView title, int* state)
		{
		...
		public static int nk_tree_push_hashed(nk_context ctx, int type, StringView title, int initial_state, sbyte* hash,
			int len, int line)
		{
			return (int) (nk_tree_base(ctx, (int) (type), null, title, (int) (initial_state), hash, (int) (len), (int) (line)));
		}

		public static int nk_tree_image_push_hashed(nk_context ctx, int type, nk_image img, StringView title,
			int initial_state, sbyte* hash, int len, int seed)
		{
		...
		public static int nk_widget(nk_rect* bounds, nk_context ctx)
		{
			...
			c.w = ((float) ((int) (c.w)));
			c.h = ((float) ((int) (c.h)));
			nk_unify(&v, &c, (float) (bounds->x), (float) (bounds->y), (float) (bounds->x + bounds->w),
		...
		public static void nk_text_colored(nk_context ctx, StringView str, uint alignment, nk_color color)
		{
			nk_window win;
			nk_style style;
			...
			nk_widget_text(win.buffer, (nk_rect) (bounds), str, &text, (uint) (alignment), style.font);
		}

		public static void nk_text_wrap_colored(nk_context ctx, StringView str, nk_color color)
		{
			nk_window win;
			nk_style style;
			nk_vec2 item_padding = new nk_vec2();
			...
			text.background = (nk_color) (style.window.background);
			text.text = (nk_color) (color);
			nk_widget_text_wrap(win.buffer, (nk_rect) (bounds), str, &text, style.font);
		}

		public static void nk_text_(nk_context ctx, StringView str, uint alignment)
		{
			if (ctx == null) return;
			nk_text_colored(ctx, str, (uint) (alignment), (nk_color) (ctx.style.text.color));
		}

		public static void nk_text_wrap(nk_context ctx, StringView str)
		{
			if (ctx == null) return;
			nk_text_wrap_colored(ctx, str, (nk_color) (ctx.style.text.color));
		}

		public static void nk_label(nk_context ctx, StringView str, uint alignment)
		{
			nk_text_(ctx, str, (uint) (alignment));
		}

		public static void nk_label_colored(nk_context ctx, StringView str, uint align, nk_color color)
		{
			nk_text_colored(ctx, str, (uint) (align), (nk_color) (color));
		}

		public static void nk_label_wrap(nk_context ctx, StringView str)
		{
			nk_text_wrap(ctx, str);
		}

		public static void nk_label_colored_wrap(nk_context ctx, StringView str, nk_color color)
		{
			nk_text_wrap_colored(ctx, str, (nk_color) (color));
		}
		...
		public static int nk_button_push_behavior(nk_context ctx, int behavior)
		{
			...
			if ((button_stack.head) >= ((int) (sizeof (
			(button_stack.elements)) /
			sizeof (
			(button_stack.elements)[0]))))
			return (int) (0);
		...
		public static int nk_button_text_styled(nk_context ctx, nk_style_button style, StringView title)
		{
			nk_window win;
			nk_panel layout;
			nk_input _in_;
			...
			return
				(int)
					(nk_do_button_text(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), title, (uint) (style.text_alignment),
						(int) (ctx.button_behavior), style, _in_, ctx.style.font));
		}

		public static int nk_button_text(nk_context ctx, StringView title)
		{
			if (ctx == null) return (int) (0);
			return (int) (nk_button_text_styled(ctx, ctx.style.button, title));
		}

		public static int nk_button_label_styled(nk_context ctx, nk_style_button style, StringView title)
		{
			return (int) (nk_button_text_styled(ctx, style, title));
		}

		public static int nk_button_label(nk_context ctx, StringView title)
		{
			return (int) (nk_button_text(ctx, title));
		}
		...
		public static int nk_button_color(nk_context ctx, nk_color color)
		{
			...
			ret =
				(int)
					(nk_do_button(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), button, _in_, (int) (ctx.button_behavior),
						&content));
		...
		public static int nk_button_symbol_styled(nk_context ctx, nk_style_button style, int symbol)
		{
			...
			return
				(int)
					(nk_do_button_symbol(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), (int) (symbol),
						(int) (ctx.button_behavior), style, _in_, ctx.style.font));
		}
		...
		public static int nk_button_image_styled(nk_context ctx, nk_style_button style, nk_image img)
		{
			...
			return
				(int)
					(nk_do_button_image(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), (nk_image) (img),
		...
		public static int nk_button_symbol_text_styled(nk_context ctx, nk_style_button style, int symbol, StringView text,
			uint align)
		{
			nk_window win;
			nk_panel layout;
			...
			return
				(int)
					(nk_do_button_text_symbol(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), (int) (symbol), text,
						(uint) (align), (int) (ctx.button_behavior), style, ctx.style.font, _in_));
		}

		public static int nk_button_symbol_text(nk_context ctx, int symbol, StringView text, uint align)
		{
			if (ctx == null) return (int) (0);
			return (int) (nk_button_symbol_text_styled(ctx, ctx.style.button, (int) (symbol), text, (uint) (align)));
		}

		public static int nk_button_symbol_label(nk_context ctx, int symbol, StringView label, uint align)
		{
			return (int) (nk_button_symbol_text(ctx, (int) (symbol), label, (uint) (align)));
		}

		public static int nk_button_symbol_label_styled(nk_context ctx, nk_style_button style, int symbol, StringView title,
			uint align)
		{
			return (int) (nk_button_symbol_text_styled(ctx, style, (int) (symbol), title, (uint) (align)));
		}

		public static int nk_button_image_text_styled(nk_context ctx, nk_style_button style, nk_image img, StringView text,
			uint align)
		{
			nk_window win;
			nk_panel layout;
			...
			return
				(int)
					(nk_do_button_text_image(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), (nk_image) (img), text,
						(uint) (align), (int) (ctx.button_behavior), style, ctx.style.font, _in_));
		}

		public static int nk_button_image_text(nk_context ctx, nk_image img, StringView text, uint align)
		{
			return (int) (nk_button_image_text_styled(ctx, ctx.style.button, (nk_image) (img), text, (uint) (align)));
		}

		public static int nk_button_image_label(nk_context ctx, nk_image img, StringView label, uint align)
		{
			return (int) (nk_button_image_text(ctx, (nk_image) (img), label, (uint) (align)));
		}

		public static int nk_button_image_label_styled(nk_context ctx, nk_style_button style, nk_image img, StringView label,
			uint text_alignment)
		{
			return (int) (nk_button_image_text_styled(ctx, style, (nk_image) (img), label, (uint) (text_alignment)));
		}

		public static int nk_selectable_text(nk_context ctx, StringView str, uint align, int* value)
		{
			nk_window win;
			nk_panel layout;
			nk_input _in_;
			...
			return
				(int)
					(nk_do_selectable(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), str, (uint) (align), value,
						style.selectable, _in_, style.font));
		}

		public static int nk_selectable_image_text(nk_context ctx, nk_image img, StringView str, uint align, int* value)
		{
			nk_window win;
			nk_panel layout;
			nk_input _in_;
			...
			return
				(int)
					(nk_do_selectable_image(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), str, (uint) (align), value, &img,
						style.selectable, _in_, style.font));
		}

		public static int nk_select_text(nk_context ctx, StringView str, uint align, int value)
		{
			nk_selectable_text(ctx, str, (uint) (align), &value);
			return (int) (value);
		}

		public static int nk_selectable_label(nk_context ctx, StringView str, uint align, int* value)
		{
			return (int) (nk_selectable_text(ctx, str, (uint) (align), value));
		}

		public static int nk_selectable_image_label(nk_context ctx, nk_image img, StringView str, uint align, int* value)
		{
			return (int) (nk_selectable_image_text(ctx, (nk_image) (img), str, (uint) (align), value));
		}

		public static int nk_select_label(nk_context ctx, StringView str, uint align, int value)
		{
			nk_selectable_text(ctx, str, (uint) (align), &value);
			return (int) (value);
		}

		public static int nk_select_image_label(nk_context ctx, nk_image img, StringView str, uint align, int value)
		{
			nk_selectable_image_text(ctx, (nk_image) (img), str, (uint) (align), &value);
			return (int) (value);
		}

		public static int nk_select_image_text(nk_context ctx, nk_image img, StringView str, uint align, int value)
		{
			nk_selectable_image_text(ctx, (nk_image) (img), str, (uint) (align), &value);
			return (int) (value);
		}

		public static int nk_check_text(nk_context ctx, StringView text, int active)
		{
			nk_window win;
			nk_panel layout;
			nk_input _in_;
			...
			_in_ = (((state) == (NK_WIDGET_ROM)) || ((layout.flags & NK_WINDOW_ROM) != 0)) ? null : ctx.input;
			nk_do_toggle(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), &active, text, (int) (NK_TOGGLE_CHECK),
				style.checkbox, _in_, style.font);
			return (int) (active);
		}

		public static uint nk_check_flags_text(nk_context ctx, StringView text, uint flags, uint value)
		{
			int old_active;
			if ((ctx == null) || (text == null)) return (uint) (flags);
			old_active = ((int) ((flags & value) & value));
			if ((nk_check_text(ctx, text, (int) (old_active))) != 0) flags |= (uint) (value);
			else flags &= (uint) (~value);
			return (uint) (flags);
		}

		public static int nk_checkbox_text(nk_context ctx, StringView text, int* active)
		{
			int old_val;
			if (((ctx == null) || (text == null)) || (active == null)) return (int) (0);
			old_val = (int) (*active);
			*active = (int) (nk_check_text(ctx, text, (int) (*active)));
			return (int) (old_val != *active);
		}

		public static int nk_checkbox_flags_text(nk_context ctx, StringView text, uint* flags, uint value)
		{
			int active;
			if (((ctx == null) || (text == null)) || (flags == null)) return (int) (0);
			active = ((int) ((*flags & value) & value));
			if ((nk_checkbox_text(ctx, text, &active)) != 0)
			{
		...
		public static int nk_check_label(nk_context ctx, StringView label, int active)
		{
			return (int) (nk_check_text(ctx, label, (int) (active)));
		}

		public static uint nk_check_flags_label(nk_context ctx, StringView label, uint flags, uint value)
		{
			return (uint) (nk_check_flags_text(ctx, label, (uint) (flags), (uint) (value)));
		}

		public static int nk_checkbox_label(nk_context ctx, StringView label, int* active)
		{
			return (int) (nk_checkbox_text(ctx, label, active));
		}

		public static int nk_checkbox_flags_label(nk_context ctx, StringView label, uint* flags, uint value)
		{
			return (int) (nk_checkbox_flags_text(ctx, label, flags, (uint) (value)));
		}

		public static int nk_option_text(nk_context ctx, StringView text, int is_active)
		{
			nk_window win;
			nk_panel layout;
			nk_input _in_;
			...
			_in_ = (((state) == (NK_WIDGET_ROM)) || ((layout.flags & NK_WINDOW_ROM) != 0)) ? null : ctx.input;
			nk_do_toggle(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), &is_active, text, (int) (NK_TOGGLE_OPTION),
				style.option, _in_, style.font);
			return (int) (is_active);
		}

		public static int nk_radio_text(nk_context ctx, StringView text, int* active)
		{
			int old_value;
			if (((ctx == null) || (text == null)) || (active == null)) return (int) (0);
			old_value = (int) (*active);
			*active = (int) (nk_option_text(ctx, text, (int) (old_value)));
			return (int) (old_value != *active);
		}

		public static int nk_option_label(nk_context ctx, StringView label, int active)
		{
			return (int) (nk_option_text(ctx, label, (int) (active)));
		}

		public static int nk_radio_label(nk_context ctx, StringView label, int* active)
		{
			return (int) (nk_radio_text(ctx, label, active));
		}
		...
		public static int nk_slider_float(nk_context ctx, float min_value, float* value, float max_value, float value_step)
		{
			...
			*value =
				(float)
					(nk_do_slider(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), (float) (min_value), (float) (old_value),
		...
		public static int nk_progress(nk_context ctx, ulong* cur, ulong max, int is_modifyable)
		{
			...
			*cur =
				(ulong)
					(nk_do_progress(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), (ulong) (*cur), (ulong) (max),
		...
		public static uint nk_edit_string(nk_context ctx, uint flags, sbyte* memory, int* len, int max, NkPluginFilter filter)
		{
			uint hash;
			uint state;
			nk_text_edit edit;
			...
			*len = (int) ((*len) < (max - 1) ? (*len) : (max - 1));
			...
			edit._string_.Length = (int) (nk_utf_len(memory, (int) (*len)));
		...
		public static uint nk_edit_buffer(nk_context ctx, uint flags, nk_text_edit edit, NkPluginFilter filter)
		{
			...
			_in_ = (win.layout.flags & NK_WINDOW_ROM) ? null : ctx.input;
			hash = (uint) (win.edit.seq++);
			if (((win.edit.active) != 0) && ((hash) == (win.edit.name)))
			{
				if ((flags & NK_EDIT_NO_CURSOR) != 0) edit.cursor = (int) (edit._string_.Length);
				if ((flags & NK_EDIT_SELECTABLE) == 0)
				{
			...
			_in_ = (flags & NK_EDIT_READ_ONLY) ? null : _in_;
			ret_flags =
				(uint)
					(nk_do_edit(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), (uint) (flags), filter, edit, style.edit, _in_,
						style.font));
		...
		public static uint nk_edit_string_zero_terminated(nk_context ctx, uint flags, StringView buffer, int max,
		...
		public static void nk_property_(nk_context ctx, StringView name, nk_property_variant* variant, float inc_per_pixel, 
	...
	)
		{
			...
			if ((name[0]) == ('#'))
			{
				hash = (uint) (nk_murmur_hash(name, (int) (nk_strlen(name)), (uint) (win.property.seq++)));
				name++;
			}
			...
			_in_ = ((((s) == (NK_WIDGET_ROM)) && (win.property.active == 0)) || ((layout.flags & NK_WINDOW_ROM) != 0))
				? null
				: ctx.input;
			nk_do_property(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), name, variant, (float) (inc_per_pixel), buffer,
				len, state, cursor, select_begin, select_end, style.property, (int) (filter), _in_, style.font, ctx.text_edit,
			...
			if ((((_in_) != null) && (*state != NK_PROPERTY_DEFAULT)) && (win.property.active == 0))
			{
				...
				if ((*state) == (NK_PROPERTY_DRAG))
				{
					ctx.input.mouse.grab = (byte) (nk_true);
					ctx.input.mouse.grabbed = (byte) (nk_true);
				}
			}
			...
			if (((*state) == (NK_PROPERTY_DEFAULT)) && (old_state != NK_PROPERTY_DEFAULT))
			{
				...
				{
					ctx.input.mouse.grab = (byte) (nk_false);
					ctx.input.mouse.grabbed = (byte) (nk_false);
					ctx.input.mouse.ungrab = (byte) (nk_true);
				}
		...
		public static void nk_property_int(nk_context ctx, StringView name, int min, int* val, int max, int step,
			float inc_per_pixel)
		{
		...
		public static void nk_property_float(nk_context ctx, StringView name, float min, float* val, float max, float step,
			float inc_per_pixel)
		{
			nk_property_variant variant = new nk_property_variant();
			if ((((ctx == null) || (ctx.current == null)) || (name == null)) || (val == null)) return;
		...
		public static void nk_property_double(nk_context ctx, StringView name, double min, double* val, double max,
		...
		public static int nk_propertyi(nk_context ctx, StringView name, int min, int val, int max, int step,
			float inc_per_pixel)
		{
			nk_property_variant variant = new nk_property_variant();
		...
		public static float nk_propertyf(nk_context ctx, StringView name, float min, float val, float max, float step,
			float inc_per_pixel)
		{
			nk_property_variant variant = new nk_property_variant();
		...
		public static double nk_propertyd(nk_context ctx, StringView name, double min, double val, double max, double step,
			float inc_per_pixel)
		{
			nk_property_variant variant = new nk_property_variant();
		...
		public static int nk_color_pick(nk_context ctx, nk_colorf* color, int fmt)
		{
			...
			return
				(int)
					(nk_do_color_picker(&ctx.last_widget_state, win.buffer, color, (int) (fmt), (nk_rect) (bounds),
		...
		public static void nk_chart_add_slot_colored(nk_context ctx, 
		enum nk_chart_type
		

		type 
	,
		nk_color color, nk_color
		highlight 
	,
		int count,
		float min_value,
		...
		public static void nk_chart_add_slot(nk_context ctx, 
		enum nk_chart_type
	...
	,
		...
		public static uint nk_chart_push_column(nk_context ctx, nk_window win, nk_chart chart, float value, int slot)
		{
			     ...
			     (((item.y) <= (_in_.mouse.pos.y)) && ((_in_.mouse.pos.y) < (item.y + item.h)))))
			{
				...
				ret |=
					(uint)
						(((_in_.mouse.buttons[NK_BUTTON_LEFT].down == 0) && ((_in_.mouse.buttons[NK_BUTTON_LEFT].clicked) != 0))
							? NK_CHART_CLICKED
							: 0);
		...
		public static void nk_plot_function(nk_context ctx, int type, void* userdata, IntPtr* value_getter, int count,
			int offset)
		{
			int i = (int) (0);
			float min_value;
		...
		public static int nk_group_scrolled_offset_begin(nk_context ctx, uint* x_offset, uint* y_offset, StringView title,
			uint flags)
		{
			nk_rect bounds = new nk_rect();
			...
			nk_panel_alloc_space(&bounds, ctx);
			{
				nk_rect* c = &win.layout.clip;
				if (
					(!(!(((((bounds.x) > (c->x + c->w)) || ((bounds.x + bounds.w) < (c->x))) || ((bounds.y) > (c->y + c->h))) ||
					     ((bounds.y + bounds.h) < (c->y))))) && ((flags & NK_WINDOW_MOVABLE) == 0))
				{
					return (int) (0);
				}
			}
			...
			ctx.current = panel;
			nk_panel_begin(ctx, (flags & NK_WINDOW_TITLE) ? title : null, (int) (NK_PANEL_GROUP));
		...
		public static void nk_group_scrolled_end(nk_context ctx)
		{
			...
			pan.parent = win;
			ctx.current = pan;
			nk_unify(&clip, &parent.clip, (float) (pan.bounds.x), (float) (pan.bounds.y), (float) (pan.bounds.x + pan.bounds.w),
		...
		public static int nk_group_scrolled_begin(nk_context ctx, nk_scroll* scroll, StringView title, uint flags)
		{
			return (int) (nk_group_scrolled_offset_begin(ctx, &scroll->x, &scroll->y, title, (uint) (flags)));
		}

		public static int nk_group_begin_titled(nk_context ctx, sbyte* id, StringView title, uint flags)
		{
			int id_len;
			uint id_hash;
			nk_window win;
		...
		public static int nk_group_begin(nk_context ctx, StringView title, uint flags)
		{
		...
		public static int nk_list_view_begin(nk_context ctx, nk_list_view view, StringView title, uint flags, int row_height,
			int row_count)
		{
			int title_len;
			uint title_hash;
		...
		public static int nk_popup_begin(nk_context ctx, int type, StringView title, uint flags, nk_rect rect)
		{
			nk_window popup;
			nk_window win;
			nk_panel panel;
			...
			if (win.popup.name != title_hash)
			{
				...
				{
					nk_zero(popup, (ulong) (sizeof ((popup))))
					;
		...
		public static int nk_nonblock_begin(nk_context ctx, uint flags, nk_rect body, nk_rect header, int panel_type)
		{
			...
			if (popup == null)
			{
				...
				nk_command_buffer_init(popup.buffer, ctx.memory, (int) (NK_CLIPPING_ON));
			}
			else
			{
				int pressed;
		...
		public static void nk_tooltip(nk_context ctx, StringView text)
		{
			nk_style style;
			nk_vec2 padding = new nk_vec2();
			int text_len;
		...
		public static int nk_contextual_item_text(nk_context ctx, StringView text, uint alignment)
		{
			nk_window win;
			nk_input _in_;
			nk_style style;
			...
			if (
				(nk_do_button_text(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), text, (uint) (alignment),
		...
		public static int nk_contextual_item_label(nk_context ctx, StringView label, uint align)
		{
			return (int) (nk_contextual_item_text(ctx, label, (uint) (align)));
		}

		public static int nk_contextual_item_image_text(nk_context ctx, nk_image img, StringView text, uint align)
		{
			nk_window win;
			nk_input _in_;
			nk_style style;
			...
			if (
				(nk_do_button_text_image(&ctx.last_widget_state, win.buffer, (nk_rect) (bounds), (nk_image) (img), text,
					(uint) (align), (int) (NK_BUTTON_DEFAULT), style.contextual_button, style.font, _in_)) != 0)
			{
				nk_contextual_close(ctx);
				return (int) (nk_true);
			}
		...
		public static int nk_contextual_item_image_label(nk_context ctx, nk_image img, StringView label, uint align)
		{
			return (int) (nk_contextual_item_image_text(ctx, (nk_image) (img), label, (uint) (align)));
		}

		public static int nk_contextual_item_symbol_text(nk_context ctx, int symbol, StringView text, uint align)
		{
			nk_window win;
			nk_input _in_;
			nk_style style;
		...
		public static int nk_contextual_item_symbol_label(nk_context ctx, int symbol, StringView text, uint align)
		{
		...
		public static int nk_combo_begin_text(nk_context ctx, sbyte* selected, int len, nk_vec2 size)
		{
			...
			if ((nk_button_behavior(&ctx.last_widget_state, (nk_rect) (header), _in_, (int) (NK_BUTTON_DEFAULT))) != 0)
		...
		public static int nk_combo_item_text(nk_context ctx, StringView text, uint align)
		{
			return (int) (nk_contextual_item_text(ctx, text, (uint) (align)));
		}

		public static int nk_combo_item_label(nk_context ctx, StringView label, uint align)
		{
			return (int) (nk_contextual_item_label(ctx, label, (uint) (align)));
		}

		public static int nk_combo_item_image_text(nk_context ctx, nk_image img, StringView text, uint alignment)
		{
			return (int) (nk_contextual_item_image_text(ctx, (nk_image) (img), text, (uint) (alignment)));
		}

		public static int nk_combo_item_image_label(nk_context ctx, nk_image img, StringView text, uint alignment)
		{
			return (int) (nk_contextual_item_image_label(ctx, (nk_image) (img), text, (uint) (alignment)));
		}

		public static int nk_combo_item_symbol_text(nk_context ctx, int sym, StringView text, uint alignment)
		{
			return (int) (nk_contextual_item_symbol_text(ctx, (int) (sym), text, (uint) (alignment)));
		}

		public static int nk_combo_item_symbol_label(nk_context ctx, int sym, StringView label, uint alignment)
		{
		...
		public static int nk_combo_separator(nk_context ctx, sbyte* items_separated_by_separator, int separator, int selected,
		...
		public static int nk_combo_string(nk_context ctx, sbyte* items_separated_by_zeros, int selected, int count,
		...
		public static int nk_combo_callback(nk_context ctx, IntPtr* item_getter, void* userdata, int selected, int count,
			int item_height, nk_vec2 size)
		{
			int i;
			int max_height;
		...
		public static void nk_combobox_string(nk_context ctx, sbyte* items_separated_by_zeros, int* selected, int count,
			int item_height, nk_vec2 size)
		{
			*selected =
				(int)
		...
		public static void nk_combobox_separator(nk_context ctx, sbyte* items_separated_by_separator, int separator,
		...
		public static void nk_combobox_callback(nk_context ctx, IntPtr* item_getter, void* userdata, int* selected, int count,
			int item_height, nk_vec2 size)
		{
			*selected =
				(int)
		...
		public static int nk_menu_begin_text(nk_context ctx, StringView title, uint align, nk_vec2 size)
		{
			nk_window win;
			nk_input _in_;
			nk_rect header = new nk_rect();
			...
			if (
				(nk_do_button_text(&ctx.last_widget_state, win.buffer, (nk_rect) (header), title, (uint) (align),
		...
		public static int nk_menu_begin_label(nk_context ctx, StringView text, uint align, nk_vec2 size)
		{
		...
		public static int nk_menu_begin_image(nk_context ctx, sbyte* id, nk_image img, nk_vec2 size)
		{
			...
			_in_ = (((state) == (NK_WIDGET_ROM)) || ((win.layout.flags & NK_WINDOW_ROM) != 0)) ? null : ctx.input;
			if (
				(nk_do_button_image(&ctx.last_widget_state, win.buffer, (nk_rect) (header), (nk_image) (img),
		...
		public static int nk_menu_begin_symbol(nk_context ctx, sbyte* id, int sym, nk_vec2 size)
		{
			...
			_in_ = (((state) == (NK_WIDGET_ROM)) || ((win.layout.flags & NK_WINDOW_ROM) != 0)) ? null : ctx.input;
			if (
				(nk_do_button_symbol(&ctx.last_widget_state, win.buffer, (nk_rect) (header), (int) (sym), (int) (NK_BUTTON_DEFAULT),
					ctx.style.menu_button, _in_, ctx.style.font)) != 0) is_clicked = (int) (nk_true);
			return (int) (nk_menu_begin(ctx, win, id, (int) (is_clicked), (nk_rect) (header), (nk_vec2) (size)));
		}

		public static int nk_menu_begin_image_text(nk_context ctx, StringView title, uint align, nk_image img, nk_vec2 size)
		{
			nk_window win;
			nk_rect header = new nk_rect();
			nk_input _in_;
			...
			_in_ = (((state) == (NK_WIDGET_ROM)) || ((win.layout.flags & NK_WINDOW_ROM) != 0)) ? null : ctx.input;
			if (
				(nk_do_button_text_image(&ctx.last_widget_state, win.buffer, (nk_rect) (header), (nk_image) (img), title,
					(uint) (align), (int) (NK_BUTTON_DEFAULT), ctx.style.menu_button, ctx.style.font, _in_)) != 0)
				is_clicked = (int) (nk_true);
			return (int) (nk_menu_begin(ctx, win, title, (int) (is_clicked), (nk_rect) (header), (nk_vec2) (size)));
		}

		public static int nk_menu_begin_image_label(nk_context ctx, StringView title, uint align, nk_image img, nk_vec2 size)
		{
			return (int) (nk_menu_begin_image_text(ctx, title, (uint) (align), (nk_image) (img), (nk_vec2) (size)));
		}

		public static int nk_menu_begin_symbol_text(nk_context ctx, StringView title, uint align, int sym, nk_vec2 size)
		{
			nk_window win;
			nk_rect header = new nk_rect();
			nk_input _in_;
			...
			_in_ = (((state) == (NK_WIDGET_ROM)) || ((win.layout.flags & NK_WINDOW_ROM) != 0)) ? null : ctx.input;
			if (
				(nk_do_button_text_symbol(&ctx.last_widget_state, win.buffer, (nk_rect) (header), (int) (sym), title, (uint) (align),
					(int) (NK_BUTTON_DEFAULT), ctx.style.menu_button, ctx.style.font, _in_)) != 0) is_clicked = (int) (nk_true);
			return (int) (nk_menu_begin(ctx, win, title, (int) (is_clicked), (nk_rect) (header), (nk_vec2) (size)));
		}

		public static int nk_menu_begin_symbol_label(nk_context ctx, StringView title, uint align, int sym, nk_vec2 size)
		{
			return (int) (nk_menu_begin_symbol_text(ctx, title, (uint) (align), (int) (sym), (nk_vec2) (size)));
		}

		public static int nk_menu_item_text(nk_context ctx, StringView title, uint align)
		{
			return (int) (nk_contextual_item_text(ctx, title, (uint) (align)));
		}

		public static int nk_menu_item_label(nk_context ctx, StringView label, uint align)
		{
			return (int) (nk_contextual_item_label(ctx, label, (uint) (align)));
		}

		public static int nk_menu_item_image_label(nk_context ctx, nk_image img, StringView label, uint align)
		{
			return (int) (nk_contextual_item_image_label(ctx, (nk_image) (img), label, (uint) (align)));
		}

		public static int nk_menu_item_image_text(nk_context ctx, nk_image img, StringView text, uint align)
		{
			return (int) (nk_contextual_item_image_text(ctx, (nk_image) (img), text, (uint) (align)));
		}

		public static int nk_menu_item_symbol_text(nk_context ctx, int sym, StringView text, uint align)
		{
			return (int) (nk_contextual_item_symbol_text(ctx, (int) (sym), text, (uint) (align)));
		}

		public static int nk_menu_item_symbol_label(nk_context ctx, int sym, StringView label, uint align)
		{
