...
/*			parent_last = ((Command*) ((void*) ((byte*) (memory) + (buf.parent))));
			...
			if ((Nuklear.PanelHasHeader((uint) (win.flags), title)) != 0)
			{
				...
				}
				{
					...
					if ((win.flags & Nuklear.NK_WINDOW_CLOSABLE) != 0)
					{
						...
						if (
							((win.buffer.DoButtonSymbol(ref ws, (Rect) (button), (int) (style.window.header.close_symbol),
					...
					if ((win.flags & Nuklear.NK_WINDOW_MINIMIZABLE) != 0)
					{
						...
						if (
							((win.buffer.DoButtonSymbol(ref ws, (Rect) (button),
								(int)
		...
		public void PanelEnd()
		{
			    ...
			    ((window.scrollbar_hiding_timer) < (4.0f)))
			{
				...
				else scroll_has_scrolling = (int) (Nuklear.nk_false);
				{
					...
					scroll_offset =
						(float)
							(_out_.DoScrollbarv(ref state, (Rect) (scroll), (int) (scroll_has_scrolling), (float) (scroll_offset),
				...
				}
				{
					...
					scroll_offset =
						(float)
							(_out_.DoScrollbarh(ref state, (Rect) (scroll), (int) (scroll_has_scrolling), (float) (scroll_offset),
		...
		public int BeginTitled(char* name, char* title, Rect bounds, uint flags)
		{
			...
			if (win == null)
			{
				...
				win.buffer.Init((int) (Nuklear.NK_CLIPPING_ON));
		...
		public int TreeStateBase(int type, Image img, char* title, ref int state)
		{
			...
			if ((header.ButtonBehavior(ref ws, _in_, (int) (Nuklear.NK_BUTTON_DEFAULT))) != 0)
...

			{
				...
				win.buffer.DoButtonSymbol(ref ws, (Rect) (sym), (int) (symbol), (int) (Nuklear.NK_BUTTON_DEFAULT), button, null,
					style.font);
				if ((img) != null)
				{
		...
		public int TreeBase(int type, Image img, char* title, int initial_state, char* hash, int len, int line)
		{
			...
			int kkk = (int) (*state);
			int result = (int) (TreeStateBase((int) (type), img, title, ref kkk));
			*state = (uint) kkk;
			return result;
		}
		...
		public int ButtonTextStyled(StyleButton style, char* title, int len)
		{
			...
			return
				(int)
					(win.buffer.DoButtonText(ref this.last_widget_state, (Rect) (bounds), title, (int) (len),
		...
		public int ButtonColor(Color color)
		{
			...
			ret =
				(int)
					(win.buffer.DoButton(ref this.last_widget_state, (Rect) (bounds), button, _in_, (int) (this.button_behavior),
						&content));
		...
		public int ButtonSymbolStyled(StyleButton style, int symbol)
		{
			...
			return
				(int)
					(win.buffer.DoButtonSymbol(ref this.last_widget_state, (Rect) (bounds), (int) (symbol),
		...
		public int ButtonImageStyled(StyleButton style, Image img)
		{
			...
			return
				(int)
					(win.buffer.DoButtonImage(ref this.last_widget_state, (Rect) (bounds), (Image) (img), (int) (this.button_behavior),
						style, _in_));
		}
		...
		public int ButtonSymbolTextStyled(StyleButton style, int symbol, char* text, int len, uint align)
		{
			...
			return
				(int)
					(win.buffer.DoButtonTextSymbol(ref this.last_widget_state, (Rect) (bounds), (int) (symbol), text, (int) (len),
						(uint) (align), (int) (this.button_behavior), style, this.style.font, _in_));
		}
		...
		public int ButtonImageTextStyled(StyleButton style, Image img, char* text, int len, uint align)
		{
			...
			return
				(int)
					(win.buffer.DoButtonTextImage(ref this.last_widget_state, (Rect) (bounds), (Image) (img), text, (int) (len),
						(uint) (align), (int) (this.button_behavior), style, this.style.font, _in_));
		}
		...
		public int SelectableText(char* str, int len, uint align, ref int value)
		{
			...
			return
				(int)
					(win.buffer.DoSelectable(ref this.last_widget_state, (Rect) (bounds), str, (int) (len), (uint) (align), ref value,
		...
		public int SelectableImageText(Image img, char* str, int len, uint align, ref int value)
		{
			...
			return
				(int)
					(win.buffer.DoSelectableImage(ref this.last_widget_state, (Rect) (bounds), str, (int) (len), (uint) (align),
		...
		public int CheckText(char* text, int len, int active)
		{
			...
			_in_ = (((state) == (Nuklear.NK_WIDGET_ROM)) || ((layout.flags & Nuklear.NK_WINDOW_ROM) != 0)) ? null : this.input;
			win.buffer.DoToggle(ref this.last_widget_state, (Rect) (bounds), &active, text, (int) (len),
		...
		public int OptionText(char* text, int len, int is_active)
		{
			...
			_in_ = (((state) == (Nuklear.NK_WIDGET_ROM)) || ((layout.flags & Nuklear.NK_WINDOW_ROM) != 0)) ? null : this.input;
			win.buffer.DoToggle(ref this.last_widget_state, (Rect) (bounds), &is_active, text, (int) (len),
		...
		public int SliderFloat(float min_value, ref float value, float max_value, float value_step)
		{
			...
			value =
				(float)
					(win.buffer.DoSlider(ref this.last_widget_state, (Rect) (bounds), (float) (min_value), (float) (old_value),
		...
		public int Progress(ulong* cur, ulong max, int is_modifyable)
		{
			...
			*cur =
				(ulong)
					(win.buffer.DoProgress(ref this.last_widget_state, (Rect) (bounds), (ulong) (*cur), (ulong) (max),
		...
		public uint EditString(uint flags, char* memory, ref int len, int max, Nuklear.NkPluginFilter filter)
		{
			...
			filter = (filter == null) ? TextEdit.FilterDefault : filter;
			win = this.current;
			hash = (uint) (win.edit.seq);
			edit = this.text_edit;
			this.text_edit.ClearState(
				(int)
		...
		public uint EditBuffer(uint flags, TextEdit edit, Nuklear.NkPluginFilter filter)
		{
			...
			ret_flags =
				(uint)
					(win.buffer.DoEdit(ref this.last_widget_state, (Rect) (bounds), (uint) (flags), filter, edit, style.edit, _in_,
						style.font));
		...
		public int ColorPick(Colorf* color, int fmt)
		{
			...
			return
				(int)
					(win.buffer.DoColorPicker(ref this.last_widget_state, color, (int) (fmt), (Rect) (bounds),
		...
		public int NonblockBegin(uint flags, Rect body, Rect header, int panel_type)
		{
			...
			if (popup == null)
			{
				...
				popup.buffer.Init((int) (Nuklear.NK_CLIPPING_ON));
			}
			else
			{
				int pressed;
			...
			popup.buffer.PushScissor((Rect) (Nuklear.nk_null_rect));
			this.current = popup;
			PanelBegin((char*) null, (int) (panel_type));
		...
		public int TooltipBegin(float width)
		{
			...
			bounds.w = ((float) (w));
			bounds.h = ((float) (h));
			ret = PopupBegin((int) (Nuklear.NK_POPUP_DYNAMIC), "__##Tooltip##__",
		...
		public int ContextualItemText(char* text, int len, uint alignment)
		{
			...
			_in_ = (((state) == (Nuklear.NK_WIDGET_ROM)) || ((win.layout.flags & Nuklear.NK_WINDOW_ROM) != 0))
				...
				: this.input;
			if (
				(win.buffer.DoButtonText(ref this.last_widget_state, (Rect) (bounds), text, (int) (len), (uint) (alignment),
		...
		public int ComboBeginText(char* selected, int len, Vec2 size)
		{
			...
			if ((header.ButtonBehavior(ref this.last_widget_state, _in_, (int) (Nuklear.NK_BUTTON_DEFAULT))) != 0)
		...
		public int ComboCallback(Nuklear.NkComboCallback item_getter, void* userdata, int selected, int count, int item_height,
			Vec2 size)
		{
			int i;
			int max_height;
		...
		public void ComboboxCallback(Nuklear.NkComboCallback item_getter, void* userdata, int* selected, int count,
			int item_height, Vec2 size)
		{
			*selected =
		...
		public int MenuBeginText(char* title, int len, uint align, Vec2 size)
		{
			...
			if (
				(win.buffer.DoButtonText(ref this.last_widget_state, (Rect) (header), title, (int) (len), (uint) (align),
		...
		public int MenuBeginImage(char* id, Image img, Vec2 size)
		{
			...
			_in_ = (((state) == (Nuklear.NK_WIDGET_ROM)) || ((win.layout.flags & Nuklear.NK_WINDOW_ROM) != 0))
				...
				: this.input;
			if (
				(win.buffer.DoButtonImage(ref this.last_widget_state, (Rect) (header), (Image) (img),
		...
		public int MenuBeginSymbol(char* id, int sym, Vec2 size)
		{
			...
			_in_ = (((state) == (Nuklear.NK_WIDGET_ROM)) || ((win.layout.flags & Nuklear.NK_WINDOW_ROM) != 0))
				...
				: this.input;
			if (
				(win.buffer.DoButtonSymbol(ref this.last_widget_state, (Rect) (header), (int) (sym),
					(int) (Nuklear.NK_BUTTON_DEFAULT), this.style.menu_button, _in_, this.style.font)) != 0)
				is_clicked = (int) (Nuklear.nk_true);
			return (int) (MenuBegin(win, id, (int) (is_clicked), (Rect) (header), (Vec2) (size)));
		}
		...
		public int MenuBeginImageText(char* title, int len, uint align, Image img, Vec2 size)
		{
			...
			_in_ = (((state) == (Nuklear.NK_WIDGET_ROM)) || ((win.layout.flags & Nuklear.NK_WINDOW_ROM) != 0))
				...
				: this.input;
			if (
				(win.buffer.DoButtonTextImage(ref this.last_widget_state, (Rect) (header), (Image) (img), title, (int) (len),
		...
		public int MenuBeginSymbolText(char* title, int len, uint align, int sym, Vec2 size)
		{
			...
			_in_ = (((state) == (Nuklear.NK_WIDGET_ROM)) || ((win.layout.flags & Nuklear.NK_WINDOW_ROM) != 0))
				...
				: this.input;
			if (
				(win.buffer.DoButtonTextSymbol(ref this.last_widget_state, (Rect) (header), (int) (sym), title, (int) (len),
					(uint) (align), (int) (Nuklear.NK_BUTTON_DEFAULT), this.style.menu_button, this.style.font, _in_)) != 0)
				is_clicked = (int) (Nuklear.nk_true);
			return (int) (MenuBegin(win, title, (int) (is_clicked), (Rect) (header), (Vec2) (size)));
		}
