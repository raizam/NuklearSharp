...
m = (float)(Nuklear.Sqrt((float)(mtx[0] * mtx[0] + mtx[1] * mtx[1])));n = (float)(Nuklear.Sqrt((float)(mtx[2] * mtx[2] + mtx[3] * mtx[3])));comp_num_verts = (int)(TtGetGlyphShape((int)(gidx), &comp_verts));if ((comp_num_verts) > (0)) {
