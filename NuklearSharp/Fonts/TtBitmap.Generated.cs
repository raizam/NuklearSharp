...
namespace NuklearSharp
{
	...
	public unsafe partial struct TtBitmap
	{
		...
		public void TtRasterizeSortedEdges(TtEdge* e, int n, int vsubsample, int off_x, int off_y)
		{
			...
			if ((this.w) > (64)) scanline = (float*) (CRuntime.malloc((ulong) ((ulong) (this.w*2 + 1)*sizeof (float))));
			...
			while ((j) < (this.h))
			{
				...
				Nuklear.Memset(scanline, (int) (0), (ulong) ((ulong) (this.w)*sizeof (float)));
				Nuklear.Memset(scanline2, (int) (0), (ulong) ((ulong) (this.w + 1)*sizeof (float)));
				while ((*step) != null)
				{
					TtActiveEdge* z = *step;
					if (z->ey <= scan_y_top)
				...
				while (e->y0 <= scan_y_bottom)
				{
					if (e->y0 != e->y1)
					{
						TtActiveEdge* z = hh.TtNewActive(e, (int) (off_x), (float) (scan_y_top));
						if (z != null)
						{
							z->next = active;
							active = z;
				...
				if ((active) != null)
					TtActiveEdge.TtFillActiveEdgesNew(scanline, scanline2 + 1, (int) (this.w), active, (float) (scan_y_top));
				{
					float sum = (float) (0);
					for (i = (int) (0); (i) < (this.w); ++i)
					{
						float k;
						int m;
						...
						m = ((int) (k));
						if ((m) > (255)) m = (int) (255);
						this.pixels[j*this.stride + i] = ((byte) (m));
					}
				}
				step = &active;
				while ((*step) != null)
		...
		public void TtRasterize(TtPoint* pts, int* wcount, int windings, float scale_x, float scale_y, float shift_x,
			float shift_y, int off_x, int off_y, int invert)
		{
			...
			e = (TtEdge*) (CRuntime.malloc((ulong) ((ulong) sizeof (TtEdge)*(ulong) (n + 1))));
			if ((e) == (null)) return;
			n = (int) (0);
			m = (int) (0);
			for (i = (int) (0); (i) < (windings); ++i)
			...
			TtEdge.TtSortEdges(e, (int) (n));
			TtRasterizeSortedEdges(e, (int) (n), (int) (vsubsample), (int) (off_x), (int) (off_y));
			CRuntime.free(e);
		}

		public void TtRasterize(float flatness_in_pixels, TtVertex* vertices, int num_verts, float scale_x, float scale_y,
			float shift_x, float shift_y, int x_off, int y_off, int invert)
		{
			float scale = (float) ((scale_x) > (scale_y) ? scale_y : scale_x);
			int winding_count;
			int* winding_lengths;
			TtPoint* windings = TtVertex.TtFlattenCurves(vertices, (int) (num_verts), (float) (flatness_in_pixels/scale),
				&winding_lengths, &winding_count);
			if ((windings) != null)
			{
				TtRasterize(windings, winding_lengths, (int) (winding_count), (float) (scale_x), (float) (scale_y),
					(float) (shift_x), (float) (shift_y), (int) (x_off), (int) (y_off), (int) (invert));
