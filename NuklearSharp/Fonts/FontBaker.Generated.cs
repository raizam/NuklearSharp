			...
			int count)
		{
			...
			this.spc.TtPackBegin(null, (int) (width), (int) (max_height), (int) (0), (int) (1));
			{
				...
				int char_n = (int) (0);
				{
					...
					RpContext.RpPackRects((RpContext*)(this.spc.pack_info) , & custom_space, (int)(1));
					...
					config_iter = config_iter.next)
				{
					...
					do
					{
						...
						RpContext.RpPackRects((RpContext*)(this.spc.pack_info), tmp->rects, (int)(n));
						for (i = (int) (0); (i) < (n); ++i)
						{
			...
			FontConfig config_list, int font_count)
		{
				...
				config_iter = config_iter.next)
			{
				...
				do
				{
					...
					FontBakeData* tmp = &this.build[input_i++];
					this.spc.TtPackSetOversampling((uint) (cfg.oversample_h), (uint) (cfg.oversample_v));
					this.spc.TtPackFontRangesRenderIntoRects(&tmp->info, tmp->ranges, (int) (tmp->range_count), tmp->rects);
				} while ((it = it.n) != config_iter);
			}
			this.spc.TtPackEnd();
			for (input_i = (int) (0) , config_iter = config_list;
				...
				do
				{
					...
					for (i = (ulong) (0); (i) < (tmp->range_count); ++i)
					{
						...
						for (char_idx = (int) (0); (char_idx) < (range->num_chars); char_idx++)
						{
							...
							TtPackedchar.TtGetPackedQuad(range->chardata_for_range, (int) (width), (int) (height), (int) (char_idx), &dummy_x,
								&dummy_y, &q, (int) (0));
