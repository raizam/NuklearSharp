    ...
    public unsafe static partial class Nk
    {
                ...
                search += (uint) (2);
                {
                    ...
                    if ((offset) == (0))
                        return (int) ((ushort) (unicode_codepoint +
                                                nk_ttSHORT(data + index_map + 14 + segcount * 4 + 2 + 2 * item)));
                    return
                        (int) (nk_ttUSHORT(data + offset + (unicode_codepoint - start) * 2 + index_map + 14 +
                                           segcount * 6 + 2 + 2 * item));
                }
            }
            ...
            else if ((numberOfContours) == (-1))
            {
                ...
                while ((more) != 0)
                {
                    ...
                    if ((comp_num_verts) > (0))
                    {
                        ...
                        nk_memcopy(tmp + num_vertices, comp_verts,
            ...
            int* leftSideBearing)
        {
            ...
            if ((glyph_index) < (numOfLongHorMetrics))
            {
                if ((advanceWidth) != null)
                    *advanceWidth = (int) (nk_ttSHORT(info->data + info->hmtx + 4 * glyph_index));
                if ((leftSideBearing) != null)
                    *leftSideBearing = (int) (nk_ttSHORT(info->data + info->hmtx + 4 * glyph_index + 2));
            }
            else
            {
                if ((advanceWidth) != null)
                ...
                if ((leftSideBearing) != null)
                    *leftSideBearing =
                        (int) (nk_ttSHORT(info->data + info->hmtx + 4 * numOfLongHorMetrics +
            ...
            int off_x, int off_y)
        {
            ...
            while ((j) < (result->h))
            {
                ...
                if ((active) != null)
                    nk_tt__fill_active_edges_new(scanline, scanline2 + 1, (int) (result->w), active,
                        (float) (scan_y_top));
                {
                    float sum = (float) (0);
                ...
                for (j = (int) (0); (j) < (ranges[i].num_chars); ++j)
                {
                    ...
                    if ((r->was_packed) != 0)
                    {
                        ...
                        if ((spc->h_oversample) > (1))
                            nk_tt__h_prefilter(spc->pixels + r->x + r->y * spc->stride_in_bytes, (int) (r->w),
                                (int) (r->h),
                                (int) (spc->stride_in_bytes), (int) (spc->h_oversample));
                        if ((spc->v_oversample) > (1))
                            nk_tt__v_prefilter(spc->pixels + r->x + r->y * spc->stride_in_bytes, (int) (r->w),
                                (int) (r->h),
