...
namespace NuklearSharp
{
	...
	unsafe partial class CommandBuffer
	{
		...
		public void StrokePolygon(float* points, int point_count, float line_thickness,
			Color col)
		{
		...
		public void FillPolygon(float* points, int point_count, Color col)
		{
			if ((col.a == 0)) return;
		...
		public void StrokePolyline(float* points, int point_count, float line_thickness,
			Color col)
		{
			if ((col.a == 0) || (line_thickness <= 0)) return;
